...
public class Petstore {
  ...
  static {
    Entity.repository.initialize(T_ADDRESS, EntityRepository.ID_MAX_PLUS_ONE,
    ...
    Entity.repository.initialize(T_CATEGORY, EntityRepository.ID_NONE, CATEGORY_NAME,
    ...
    Entity.repository.initialize(T_ITEM, EntityRepository.ID_MAX_PLUS_ONE, ITEM_NAME,
    ...
    Entity.repository.initialize(T_PRODUCT, EntityRepository.ID_NONE, PRODUCT_NAME,
    ...
    Entity.repository.initialize(T_SELLER_CONTACT_INFO, EntityRepository.ID_MAX_PLUS_ONE,
    ...
    Entity.repository.initialize(T_TAG, EntityRepository.ID_MAX_PLUS_ONE, TAG_TAG,
    ...
    Entity.repository.initialize(T_TAG_ITEM, EntityRepository.ID_NONE,
    ...
    Entity.repository.initialize(T_ZIP_LOCATION, EntityRepository.ID_NONE, ZIP_LOCATION_ZIP_CODE,
