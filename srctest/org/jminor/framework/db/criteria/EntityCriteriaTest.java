...
public class EntityCriteriaTest {
  ...
  public void test() {
    ...
    final CriteriaSet set1 = new CriteriaSet(
            ...
            new PropertyCriteria(new Property("stringProperty", String.class), SearchType.LIKE, "value"),
            new PropertyCriteria(new Property("intProperty", Integer.class), SearchType.LIKE, 666)
    );
    ...
    final CriteriaSet set2 = new CriteriaSet(
            CriteriaSet.Conjunction.AND,
            new PropertyCriteria(new Property("doubleProperty", Double.class), SearchType.LIKE, 666.666),
            new PropertyCriteria(new Property("stringProperty2", String.class), SearchType.LIKE, "value2").setCaseSensitive(false)
    );
