...
public class ModelTestDomain {
  ...
  static {
    EntityRepository.get().initialize(T_TEST_DETAIL_ENTITY,
    ...
    EntityRepository.get().initialize(T_TEST_MASTER_ENTITY, IdSource.ID_NONE, null,
            ...
            new Property.EntityProperty(ENTITY_REF, ENTITY_REF, T_TEST_DETAIL_ENTITY,
                    new Property(ENTITY_ID_PROP)),
            new Property.DenormalizedViewProperty(DENORM_PROP, T_TEST_DETAIL_ENTITY, NAME, DENORM_PROP));
  }
}
