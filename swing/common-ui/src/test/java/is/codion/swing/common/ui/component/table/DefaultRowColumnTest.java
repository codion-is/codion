...
public final class DefaultRowColumnTest {
	...
	@Test
	void test() {
		RowColumn rowColumn1 = new DefaultFilterTableSearchModel.DefaultRowColumn(1, 2);
		...
		assertEquals(rowColumn1, new DefaultFilterTableSearchModel.DefaultRowColumn(1, 2));
		assertNotEquals(rowColumn1, new DefaultFilterTableSearchModel.DefaultRowColumn(2, 1));
