...
public class TemporalValuesTest {
  ...
  public void testTime() throws Exception {
    ...
    TemporalValues.localTimeValueLink(textField, timePropertyValue, format);
  ...
  public void testDate() throws Exception {
    ...
    TemporalValues.localDateValueLink(textField, datePropertyValue, DateFormats.SHORT_DOT);
  ...
  public void testTimestamp() throws Exception {
    ...
    TemporalValues.localDateTimeValueLink(textField, timestampPropertyValue, DateFormats.SHORT_TIMESTAMP);
