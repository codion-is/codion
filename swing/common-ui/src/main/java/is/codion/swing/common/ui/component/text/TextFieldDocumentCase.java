...
final class TextFieldDocumentCase {
	...
	TextFieldDocumentCase(Document document, CaseDocumentFilter.DocumentCase documentCase) {
		...
		if (document instanceof SizedDocument) {
			((CaseDocumentFilter) ((SizedDocument) document).getDocumentFilter()).setDocumentCase(documentCase);
		}
			...
			if (documentFilter == null) {
				((AbstractDocument) document).setDocumentFilter(new CaseDocumentFilter(documentCase));
			}
