...
final class ExceptionPanel extends JPanel {
	...
	private final JScrollPane stackTraceScrollPane = ScrollPaneBuilder.builder(stackTraceArea)
					...
					.build();
	private final JButton printButton = ButtonBuilder.builder(Control.builder()
					...
					.visible(false)
					.build();
	private final JButton saveButton = ButtonBuilder.builder(Control.builder()
					...
					.visible(false)
					.build();
	private final JButton closeButton = ButtonBuilder.builder(Control.builder()
									.command(this::closeDialog)
									.caption(MESSAGES.getString("close"))
									.description(MESSAGES.getString("close_dialog")))
					.build();
	private final JButton copyButton = ButtonBuilder.builder(Control.builder()
