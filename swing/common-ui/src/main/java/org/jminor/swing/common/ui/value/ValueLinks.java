...
import static org.jminor.swing.common.ui.value.ComponentValues.*;
...
public final class ValueLinks {
  ...
  public static void intSpinnerValueLink(final Object owner, final String propertyName, final EventObserver<Integer> valueChangeEvent,
    ...
    intSpinnerValueLink(spinnerModel, propertyValue(owner, propertyName, int.class, valueChangeEvent), readOnly);
  }
