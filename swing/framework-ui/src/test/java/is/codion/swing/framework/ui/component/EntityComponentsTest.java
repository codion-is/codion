...
public final class EntityComponentsTest {
	...
	private final SwingEntityEditModel editModel = new SwingEntityEditModel(Detail.TYPE, CONNECTION);
	...
	void booleanComboBox() {
		...
		ComponentValue<JComboBox<Item<Boolean>>, Boolean> componentValue =
						entityComponents.booleanComboBox(Detail.BOOLEAN_NULLABLE)
										...
										.buildValue();
		SwingFilterComboBoxModel<Item<Boolean>> boxModel = (SwingFilterComboBoxModel<Item<Boolean>>) componentValue.component().getModel();
	...
	void nullableUnsortedItemComboBox() {
		ComponentValue<JComboBox<Item<Integer>>, Integer> componentValue =
						entityComponents.itemComboBox(Detail.INT_ITEMS)
										.sorted(false)
										.buildValue();
		SwingFilterComboBoxModel<Item<Integer>> model = (SwingFilterComboBoxModel<Item<Integer>>) componentValue.component().getModel();
	...
	void enumComboBox() {
		...
		SwingFilterComboBoxModel<EnumType> comboBoxModel = (SwingFilterComboBoxModel<EnumType>) comboBox.getModel();
	...
	@Test
	void component() {
		EntityDefinition definition = CONNECTION.entities().definition(Detail.TYPE);
