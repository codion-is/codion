...
public class EntityTablePanelTest {
	...
	void orderQueryBySortOrder() {
		...
		EntityTablePanel tablePanel = new EntityTablePanel(tableModel);
		tablePanel.table().model().sorter().sort(Employee.NAME).set(SortOrder.ASCENDING);
		...
		tablePanel.table().model().sorter().sort(Employee.HIREDATE).set(SortOrder.DESCENDING);
		tablePanel.table().model().sorter().sort(Employee.NAME).add(SortOrder.ASCENDING);
