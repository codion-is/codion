...
public final class EntityLookupField extends JTextField {
   ...
   */
  public static Entity lookupEntity(final EntityIdentity entityId, final EntityConnectionProvider connectionProvider,
   ...
   * @see EntityDefinition#getSearchProperties()
   */
  public static List<Entity> lookupEntities(final EntityIdentity entityId, final EntityConnectionProvider connectionProvider,
                                            final JComponent dialogParent, final String lookupCaption, final String dialogTitle) {
  ...
  private static List<Entity> lookupEntities(final EntityIdentity entityId, final EntityConnectionProvider connectionProvider,
