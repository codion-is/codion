...
public class EntityTablePanel extends JPanel implements DialogExceptionHandler {
  ...
  public final void viewSelectionDependencies() {
    ...
    try {
      showWaitCursor(this);
      final Map<Identity, Collection<Entity>> dependencies =
  ...
  public static void showDependenciesDialog(final Collection<Entity> entities, final EntityConnectionProvider connectionProvider,
    ...
    try {
      final Map<Identity, Collection<Entity>> dependencies = connectionProvider.getConnection().selectDependencies(entities);
  ...
  public static EntityTablePanel createEntityTablePanel(final Collection<Entity> entities,
    ...
    final Identity entityId = entities.iterator().next().getEntityId();
  ...
  private static void showDependenciesDialog(final Map<Identity, Collection<Entity>> dependencies,
                                             final EntityConnectionProvider connectionProvider,
  ...
  private static JPanel createDependenciesPanel(final Map<Identity, Collection<Entity>> dependencies,
                                                final EntityConnectionProvider connectionProvider) {
    final JPanel panel = new JPanel(new BorderLayout());
    final JTabbedPane tabPane = new JTabbedPane(JTabbedPane.TOP);
    for (final Map.Entry<Identity, Collection<Entity>> entry : dependencies.entrySet()) {
