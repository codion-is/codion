 ...
 */
public final class TabPanelLayout implements PanelLayout {
  ...
  private static final ResourceBundle MESSAGES = ResourceBundle.getBundle(TabPanelLayout.class.getName());
  ...
  private TabPanelLayout(DefaultBuilder builder) {
  ...
  public void layoutPanel(EntityPanel entityPanel) {
    ...
    PanelLayout.super.layoutPanel(entityPanel);
  ...
  private static final class ResizeHorizontallyAction extends AbstractAction {
    ...
    private static void resizePanel(EntityPanel panel, EntityPanel.Direction direction) {
      TabPanelLayout detailPanelLayout = panel.panelLayout();
  ...
  final class TabDetailPanelController implements DetailController {
  ...
  private static final class DefaultBuilder implements Builder {
    ...
    public TabPanelLayout build() {
      return new TabPanelLayout(this);
    }
  }
