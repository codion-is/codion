...
final class KeyboardShortcutsPanel extends JPanel {
	...
	private static JPanel tablePanel() {
		return gridLayoutPanel(0, 2)
						...
						.addAll(new JLabel(MESSAGES.getString("view_selected_item")), new JLabel(CTRL + ALT + "V"))
						...
						.addAll(new JLabel(MESSAGES.getString("copy_selected_column")), new JLabel(CTRL + ALT + SHIFT + "C"))
