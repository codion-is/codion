...
* <<manual/manual.adoc#_reactive_classes, Reactive State Management>> Core with <<manual/manual.adoc#_value, Value>>, <<manual/manual.adoc#_state, State>> and <<manual/manual.adoc#_event, Event>>
...
** <<manual/manual.adoc#_table_export, Denormalized Data Export UI>>
* Automated Data Entry Forms with <<manual/manual.adoc#_entityeditpanel, EntityEditPanel>>
* Full https://www.youtube.com/watch?v=2dDKjeqJJeQ[Keyboard Control and Navigation] see <<manual/manual.adoc#_keyboard_shortcuts, Keyboard Shortcuts>>
...
* Lightweight, Pluggable Application Server with <<technical/technical.adoc#_entity_server, EntityServer>>
...
* Server monitoring UI with <<technical/technical.adoc#_server_monitor, Server Monitor>>.
* Flexible Client Deployment Models
** <<manual/manual.adoc#_localentityconnection, Local JDBC Connection>>
** <<manual/manual.adoc#_remoteentityconnection, Client-Server (RMI)>>
** <<manual/manual.adoc#_httpentityconnection, HTTP Client-Server>>
