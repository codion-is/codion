...
The *EntityEditModel* works with a single entity instance, which can be retrieved and set via the EditableEntity instance accessible via the {url-javadoc}{framework-model}/is/codion/framework/model/EntityEditModel.html#entity{opar}{cpar}[entity()] method.
