...
{url-javadoc}{swing-framework-ui}/is/codion/swing/framework/ui/EntityEditComponentPanel.html#createFormattedTextField{opar}is.codion.framework.domain.entity.attribute.Attribute{cpar}[createFormattedTextField(attribute)]
