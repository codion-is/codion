...
The domain model provides a {url-javadoc}{framework-domain}/is/codion/framework/domain/entity/Entities.html[Entities] instance via {url-javadoc}{framework-domain}/is/codion/framework/domain/Domain.html#getEntities{opar}{cpar}[getEntities()], which contains the entity definitions and serves as a factory for *Entity* and *Key* instances.
