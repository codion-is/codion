...
----
<1> The *DomainType* is identified by the (simple/short) name of the domain implementation class.
<2> The *DomainType* instance serves as a factory for *EntityTypes* associated with that domain.
<3> Each *EntityType* instance serves as a factory for *Attributes* and *ForeignKeys* associated with that entity.
