...
A Codion domain model is based on the {url-javadoc}{framework-domain}/is/codion/framework/domain/entity/Entity.html[Entity] interface, which represents a row in a table. To define a domain model start by creating constants representing the following:
