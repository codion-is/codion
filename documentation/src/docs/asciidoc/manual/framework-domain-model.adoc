...
To unit test the CRUD operations on the domain model extend {url-javadoc}{framework-domain-test}/is/codion/framework/domain/entity/test/DomainTest.html[DomainTest].
...
* {url-javadoc}{framework-domain-test}/is/codion/framework/domain/entity/test/DomainTest.html#initializeForeignKeyEntity{opar}is.codion.framework.domain.entity.attribute.ForeignKey{comma}java.util.Map{cpar}[initializeForeignKeyEntity] should return an entity instance for the given foreign key to use for a foreign key reference required for inserting the entity being tested.
* {url-javadoc}{framework-domain-test}/is/codion/framework/domain/entity/test/DomainTest.html#initializeTestEntity{opar}is.codion.framework.domain.entity.EntityType{comma}java.util.Map{cpar}[initializeTestEntity] should return an entity to use as basis for the unit test, that is, the entity that should be inserted, selected, updated and finally deleted.
* {url-javadoc}{framework-domain-test}/is/codion/framework/domain/entity/test/DomainTest.html#modifyEntity{opar}is.codion.framework.domain.entity.Entity{comma}java.util.Map{cpar}[modifyEntity] should simply leave the entity in a modified state so that it can be used for update test, since the database layer throws an exception if an unmodified entity is updated.
