...
When using the HTTP connection in an application using a custom data type, you must implement a {url-javadoc}{framework-json}/is/codion/framework/json/domain/EntityObjectMapperFactory.html[EntityObjectMapperFactory], providing a {url-javadoc}{framework-json}/is/codion/framework/json/domain/EntityObjectMapper.html[EntityObjectMapper] containing a serializer/deserializer for the custom types.
