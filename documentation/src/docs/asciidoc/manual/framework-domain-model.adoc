...
Each entity type is defined by calling {url-javadoc}/is/codion/framework/domain/Domain.html#define-java.lang.String-is.codion.framework.domain.property.Property.Builder...-[Domain.define]. The framework assumes the *entityId* is the table name, unless the *tableName* parameter is specified.
