...
[source,java]
----
include::{dir-world-source}/is/codion/framework/demos/world/domain/api/World.java[tags=entityTypesAndAttributes]
----
...
[source,java,indent=0]
----
include::{dir-world-source}/is/codion/framework/demos/world/domain/WorldImpl.java[tags=derivedPropertyProvider]
----
...
[source,java,indent=0]
----
include::{dir-world-source}/is/codion/framework/demos/world/domain/WorldImpl.java[tags=colorProvider]
----
