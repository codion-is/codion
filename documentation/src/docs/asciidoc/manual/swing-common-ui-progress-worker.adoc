...
== {url-javadoc}{swing-common-model}/is/codion/swing/common/model/worker/ProgressWorker.TaskHandler.html[TaskHandler]

[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/swing/common/model/worker/ProgressWorkerDemo.java[tags=taskHandler]
----
...
== {url-javadoc}{swing-common-model}/is/codion/swing/common/model/worker/ProgressWorker.ResultTaskHandler.html[ResultTaskHandler]

[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/swing/common/model/worker/ProgressWorkerDemo.java[tags=resultTaskHandler]
----
...
== {url-javadoc}{swing-common-model}/is/codion/swing/common/model/worker/ProgressWorker.ProgressTaskHandler.html[ProgressTaskHandler]

[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/swing/common/model/worker/ProgressWorkerDemo.java[tags=progressTaskHandler]
----
