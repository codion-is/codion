...
The primary condition mechanism is the {url-javadoc}{framework-model}/is.codion.framework.model/is/codion/framework/model/EntityTableConditionModel.html[EntityTableConditionModel], which provides a flexible way to build complex queries:
