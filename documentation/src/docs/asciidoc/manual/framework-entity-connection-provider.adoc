...
----
include::{dir-chinook-source}/org/jminor/framework/demos/chinook/manual/EntityConnectionProviderDemo.java[tags=local]
----

== RemoteEntityConnectionProvider

{url-javadoc}/org/jminor/framework/db/rmi/RemoteEntityConnectionProvider.html[RemoteEntityConnectionProvider]

Provides a connection based on a remote RMI connection.

[source,java,indent=0]
----
include::{dir-chinook-source}/org/jminor/framework/demos/chinook/manual/EntityConnectionProviderDemo.java[tags=remote]
----
...
[source,java,indent=0]
----
include::{dir-chinook-source}/org/jminor/framework/demos/chinook/manual/EntityConnectionProviderDemo.java[tags=http]
----
