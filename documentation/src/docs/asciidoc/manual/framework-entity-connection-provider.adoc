...
You can override the default description using the configuration property {url-javadoc}{framework-db-core}/is/codion/framework/db/EntityConnectionProvider.html#DESCRIPTION[EntityConnectionProvider.DESCRIPTION]

[source,java]
----
EntityConnectionProvider.DESCRIPTION.set("MyDescription");
----
