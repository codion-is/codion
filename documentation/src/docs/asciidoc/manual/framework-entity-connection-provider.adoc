...
{url-javadoc}/is/codion/framework/db/local/LocalEntityConnectionProvider.html[LocalEntityConnectionProvider]
...
{url-javadoc}/is/codion/framework/db/rmi/RemoteEntityConnectionProvider.html[RemoteEntityConnectionProvider]
...
{url-javadoc}/is/codion/framework/db/http/HttpEntityConnectionProvider.html[HttpEntityConnectionProvider]
