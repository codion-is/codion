...
The {url-javadoc}/is/codion/swing/framework/ui/EntityPanel.html[EntityPanel] is the base UI class for working with entity instances. It usually consists of an {url-javadoc}/is/codion/swing/framework/ui/EntityTablePanel.html[EntityTablePanel], an {url-javadoc}/is/codion/swing/framework/ui/EntityEditPanel.html[EntityEditPanel], and a set of detail panels representing the entities having a master/detail relationship with the underlying entity.
