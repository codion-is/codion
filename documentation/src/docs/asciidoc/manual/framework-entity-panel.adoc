...
----
include::{dir-source}/is/codion/framework/demos/manual/framework/EntityPanels.java[tags=extended]
----

[source,java,indent=0]
----
include::{dir-source}/is/codion/framework/demos/manual/framework/EntityPanels.java[tags=setup]
----
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/framework/demos/manual/framework/EntityPanels.java[tags=detailPanel]
----