...
Events are instantiated via factory methods in the {url-javadoc}/is/codion/common/event/Event.html[Event] class.
...
States are instantiated via factory methods in the {url-javadoc}/is/codion/common/state/State.html[State] class.
...
Values are instantiated via factory methods in the {url-javadoc}/is/codion/common/value/Value.html[Value] class.
