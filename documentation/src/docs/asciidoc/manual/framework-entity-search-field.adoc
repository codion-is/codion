...
* Single entity selection, several entities collected via a `MultiValueInput`
...
To collect entities over several searches, wrap the search field in a {url-javadoc}{swing-common-ui}/is/codion/swing/common/ui/component/multivalue/MultiValueInput.html[MultiValueInput], as the table condition panel does for the IN operator of a foreign key condition.
