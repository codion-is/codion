...
To collect entities over several searches, wrap the search field in a {url-javadoc}{swing-common-ui}/is/codion/swing/common/ui/component/multi/MultiInput.html[MultiInput], as the table condition panel does for the IN operator of a foreign key condition.
