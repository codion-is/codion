...
The most common error is mismatched selection modes:

[source,java]
.Wrong - will throw IllegalArgumentException
----
include::{dir-chinook-source}/is/codion/demos/chinook/manual/FrameworkUIDemo.java[tags=searchFieldMismatchError]
----
