...
[source,java]
----
include::{dir-source}/is/codion/manual/app/store/model/AddressModel.java[tags=addressModel]
----

[source,java]
----
include::{dir-source}/is/codion/manual/app/store/model/CustomerAddressModel.java[tags=customerAddressModel]
----
...
[source,java]
----
include::{dir-source}/is/codion/manual/app/store/model/StoreApplicationModel.java[tags=storeAppModel]
----

[#_event_binding]
== Event binding

The model layer classes expose a number of <<manual.adoc#_reactive_classes, *Event*, *State* and *Value* observers>>.

[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/app/store/model/CustomerModel.java[tags=bindEvents]
----
