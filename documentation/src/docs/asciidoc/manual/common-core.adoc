...
NOTE: Both listeners and consumer are notified each time the event is trigger, regardless of whether *run* or *accept* is used, listeners and consumers are notified in the order they were added.
