...
Three common classes used throughout the framework are {url-javadoc}{common-core}/is/codion/common/event/Event.html[Event], {url-javadoc}{common-core}/is/codion/common/state/State.html[State] and {url-javadoc}{common-core}/is/codion/common/value/Value.html[Value] and their respective observers {url-javadoc}{common-core}/is/codion/common/event/EventObserver.html[EventObserver], {url-javadoc}{common-core}/is/codion/common/state/StateObserver.html[StateObserver] and {url-javadoc}{common-core}/is/codion/common/value/ValueObserver.html[ValueObserver].
...
The {url-javadoc}{common-core}/is/codion/common/event/Event.html[Event] class is a synchronous event implementation used throughout the framework. Classes typically expose their event observers via public *observer* methods. Events are triggered by calling the *run* method in case no data is associated with the event or *accept* in case data should be propogated to listeners.
...
Event listeners must implement either https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Runnable.html[Runnable] or https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/function/Consumer.html[Consumer], depending on whether data is associated with the event.
