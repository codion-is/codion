...
Any *Action* object can be linked to a *State* object via the *Utilities.linkToEnabledState* method, where the action's *enabled* status is updated according to the state.
