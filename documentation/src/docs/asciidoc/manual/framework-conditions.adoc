...
*{url-javadoc}{framework-db-core}/is/codion/framework/domain/entity/attribute/Condition.html[Condition]*::
...
*{url-javadoc}{framework-db-core}/is/codion/framework/domain/entity/attribute/Condition.Combination.html[Condition.Combination]*::
