...
*{url-javadoc}{framework-domain}/is/codion/framework/domain/entity/attribute/Condition.html[Condition]*::
...
*{url-javadoc}{framework-domain}/is/codion/framework/domain/entity/attribute/Condition.Combination.html[Condition.Combination]*::
