...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/framework/domain/ReportDemo.java[tags=reportTypes]
----

[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/framework/domain/ReportDemo.java[tags=addReports]
----

[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/framework/domain/ReportDemo.java[tags=fillReports]
----
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/plugin/jasperreports/JasperReportsDemo.java[tags=jasperReportDataSource]
----
