...
For the simplest case, where a single print action is required, a custom control can be associated with the *PRINT* ControlId, this control will appear in the Print submenu in the table popup menu as well as on the table toolbar.
