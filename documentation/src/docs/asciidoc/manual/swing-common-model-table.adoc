...
The {url-javadoc}{swing-common-model}/is/codion/swing/common/model/component/table/SwingFilterTableModel.html[SwingFilterTableModel] is a table model central to the framework.
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/swing/common/model/component/table/FilterTableModelDemo.java[tags=export]
----