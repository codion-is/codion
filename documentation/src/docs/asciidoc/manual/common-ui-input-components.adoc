...
[source,java,indent=0]
----
include::{dir-source}/is/codion/framework/demos/manual/common/InputControls.java[tags=filterComboBoxModel]
----
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/framework/demos/manual/common/InputControls.java[tags=comboBoxCompletion]
----
