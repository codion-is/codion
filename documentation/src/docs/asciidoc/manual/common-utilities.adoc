...
----
include::{dir-source}/is/codion/manual/common/utilities/scheduler/TaskSchedulerDemo.java[tags=taskScheduler]
----
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/common/utilities/scheduler/TaskSchedulerDemo.java[tags=taskSchedulerAutoStart]
----
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/common/utilities/scheduler/TaskSchedulerDemo.java[tags=taskSchedulerCustomThreadFactory]
----
