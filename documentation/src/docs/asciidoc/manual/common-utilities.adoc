...
{url-javadoc}{common-core}/is/codion/common/scheduler/TaskScheduler.html[TaskScheduler] provides a simple, lightweight way to execute tasks periodically on a background thread.
