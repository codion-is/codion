...
{url-entity-connection}#select{opar}is.codion.framework.db.criteria.Criteria{cpar}[select(Criteria criteria)]

{url-entity-connection}#select{opar}is.codion.framework.db.condition.Select{cpar}[select(Select select)]

{url-entity-connection}#selectSingle{opar}is.codion.framework.db.criteria.Criteria{cpar}[selectSingle(Criteria criteria)]

{url-entity-connection}#selectSingle{opar}is.codion.framework.db.condition.Select{cpar}[selectSingle(Select select)]
...
{url-entity-connection}#select{opar}is.codion.framework.domain.entity.Column{comma}is.codion.framework.db.criteria.Criteria{cpar}[select(Column<T> column, Criteria criteria)]

{url-entity-connection}#select{opar}is.codion.framework.domain.entity.Column{comma}is.codion.framework.db.condition.Select{cpar}[select(Column<T> column, Select condition)]
...
{url-local-entity-connection}#iterator{opar}is.codion.framework.db.criteria.Criteria{cpar}[iterator(Criteria criteria)]

{url-local-entity-connection}#iterator{opar}is.codion.framework.db.condition.Select{cpar}[iterator(Select select)]
...
{url-entity-connection}#rowCount{opar}is.codion.framework.db.criteria.Criteria{cpar}[rowCount(Criteria criteria)]
...
** {url-entity-connection}#update{opar}is.codion.framework.db.condition.Update{cpar}[update(Update update)]
...
** {url-entity-connection}#delete{opar}is.codion.framework.db.criteria.Criteria{cpar}[delete(Criteria criteria)]
