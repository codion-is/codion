...
{url-entity-connection}#selectValues-is.codion.framework.domain.attribute.Attribute-is.codion.framework.db.condition.EntityCondition-[selectValues(Attribute attribute, EntityCondition condition)]
