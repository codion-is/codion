...
----
include::{dir-chinook-source}/is/codion/demos/chinook/domain/impl/ChinookImpl.java[tags=fetchDepth0]
----

[source,java,indent=0]
----
include::{dir-chinook-source}/is/codion/demos/chinook/domain/impl/ChinookImpl.java[tags=fetchDepth2]
----
