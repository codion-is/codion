...
{url-entity-connection}#select-is.codion.framework.db.condition.EntitySelectCondition-[select(EntitySelectCondition condition)]
...
{url-entity-connection}#select-is.codion.framework.domain.entity.EntityType-java.lang.String-java.lang.Object...-[select(EntityType entityType, Attribute attribute, Object... values)]
...
{url-entity-connection}#selectSingle-is.codion.framework.db.condition.EntitySelectCondition-[selectSingle(EntitySelectCondition condition)]
...
{url-entity-connection}#selectSingle-is.codion.framework.domain.entity.Entity.Key-[selectSingle(Entity.Key key)]
...
{url-entity-connection}#selectSingle-is.codion.framework.domain.entity.EntityType-java.lang.String-java.lang.Object...-[selectSingle(EntityType entityType, Attribute attribute, Object... values)]
...
{url-entity-connection}#selectValues-is.codion.framework.domain.entity.Attribute-is.codion.framework.db.condition.EntityCondition-[selectValues(Attribute attribute, EntityCondition condition)]
...
{url-entity-connection}#selectRowCount-is.codion.framework.db.condition.EntityCondition-[selectRowCount(EntityCondition condition)]

[source,java,indent=0]
----
include::{dir-chinook-source}/is/codion/framework/demos/chinook/manual/EntityConnectionDemo.java[tags=selectRowCount]
----
...
** {url-entity-connection}#update-is.codion.framework.db.condition.EntityUpdateCondition-[update(EntityUpdateCondition condition)]
...
** {url-entity-connection}#delete-is.codion.framework.db.condition.EntityCondition-[delete(EntityCondition condition)]
...
** {url-entity-connection}#delete-is.codion.framework.domain.entity.Entity.Key-[delete(Entity.Key key)]
...
** {url-entity-connection}#executeProcedure-is.codion.common.db.operation.ProcedureType-java.lang.Object...-[executeProcedure(ProcedureType procedureType, Object... arguments)]
...
** {url-entity-connection}#executeFunction-is.codion.common.db.operation.FunctionType-java.lang.Object...-[executeFunction(FunctionType functionType, Object... arguments)]
...
** {url-entity-connection}#fillReport-is.codion.common.db.reports.ReportWrapper-[fillReport(ReportWrapper reportWrapper)]
