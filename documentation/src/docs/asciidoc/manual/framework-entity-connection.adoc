...
{url-entity-connection}#select{opar}is.codion.framework.db.condition.SelectCondition{cpar}[select(SelectCondition condition)]

{url-entity-connection}#selectSingle{opar}is.codion.framework.db.criteria.Criteria{cpar}[selectSingle(Criteria criteria)]

{url-entity-connection}#selectSingle{opar}is.codion.framework.db.condition.SelectCondition{cpar}[selectSingle(SelectCondition condition)]
...
{url-entity-connection}#select{opar}is.codion.framework.domain.entity.Column{comma}is.codion.framework.db.condition.SelectCondition{cpar}[select(Column<T> column, SelectCondition condition)]
...
{url-local-entity-connection}#iterator{opar}is.codion.framework.db.condition.SelectCondition{cpar}[iterator(Condition condition)]
...
** {url-entity-connection}#update{opar}is.codion.framework.db.condition.UpdateCondition{cpar}[update(UpdateCondition condition)]
