...
{url-entity-connection}#select-is.codion.framework.db.condition.SelectCondition-[select(SelectCondition condition)]
...
{url-entity-connection}#selectSingle-is.codion.framework.db.condition.SelectCondition-[selectSingle(SelectCondition condition)]
...
** {url-entity-connection}#fillReport-is.codion.common.db.reports.ReportType-T-[fillReport(ReportType reportType, P reportParameters)]
