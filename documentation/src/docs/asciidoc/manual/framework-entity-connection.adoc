...
{url-entity-connection}#select{opar}is.codion.framework.domain.entity.Attribute{comma}T{cpar}[select(Attribute<T> attribute, T value)]
...
{url-entity-connection}#selectSingle{opar}is.codion.framework.domain.entity.Attribute{comma}T{cpar}[selectSingle(Attribute<T> attribute, T value)]
...
{url-entity-connection}#select{opar}is.codion.framework.domain.entity.Attribute{comma}is.codion.framework.db.condition.Condition{cpar}[select(Attribute<T> attribute, Condition condition)]
