...
{url-entity-connection}#selectDependencies{opar}java.util.Collection{cpar}[selectDependencies(Collection<Entity> entities)]
...
** {url-entity-connection}#executeFunction{opar}is.codion.common.db.operation.FunctionType{cpar}[executeFunction(FunctionType functionType)]
** {url-entity-connection}#executeFunction{opar}is.codion.common.db.operation.FunctionType{comma}T{cpar}[executeFunction(FunctionType functionType, T argument)]
...
** {url-entity-connection}#executeProcedure{opar}is.codion.common.db.operation.ProcedureType{cpar}[executeProcedure(ProcedureType procedureType)]
** {url-entity-connection}#executeProcedure{opar}is.codion.common.db.operation.ProcedureType{comma}T{cpar}[executeProcedure(ProcedureType procedureType, T argument)]
