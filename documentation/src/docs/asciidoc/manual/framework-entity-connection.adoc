...
** {url-entity-connection}#executeFunction-is.codion.common.db.operation.FunctionType-java.util.List-[executeFunction(FunctionType functionType, T... arguments)]
...
** {url-entity-connection}#executeProcedure-is.codion.common.db.operation.ProcedureType-java.util.List-[executeProcedure(ProcedureType procedureType, T... arguments)]
