...
{url-entity-connection}#selectValues-java.lang.String-is.codion.framework.db.condition.EntityCondition-[selectValues(String propertyId, EntityCondition condition)]
