...
{url-entity-connection}#select{opar}is.codion.framework.domain.entity.attribute.Condition{cpar}[select(Condition condition)]

{url-entity-connection}#select{opar}is.codion.framework.db.EntityConnection.Select{cpar}[select(Select select)]

{url-entity-connection}#selectSingle{opar}is.codion.framework.domain.entity.attribute.Condition{cpar}[selectSingle(Condition condition)]
...
{url-entity-connection}#select{opar}is.codion.framework.domain.entity.attribute.Column{comma}is.codion.framework.domain.entity.attribute.Condition{cpar}[select(Column<T> column, Condition condition)]
...
{url-local-entity-connection}#iterator{opar}is.codion.framework.domain.entity.attribute.Condition{cpar}[iterator(Condition condition)]
...
** {url-entity-connection}#delete{opar}is.codion.framework.domain.entity.attribute.Condition{cpar}[delete(Condition condition)]
