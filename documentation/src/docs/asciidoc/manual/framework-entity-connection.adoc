...
{url-entity-connection}#select{opar}is.codion.framework.domain.entity.Attribute{comma}is.codion.framework.db.criteria.Criteria{cpar}[select(Attribute<T> attribute, Criteria criteria)]
