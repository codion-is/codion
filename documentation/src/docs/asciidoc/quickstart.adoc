...
----
include::{dir-source}/is/codion/manual/quickstart/Example.java[tags=store]
----
====
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/quickstart/Example.java[tags=storeDomain]
----
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/quickstart/Example.java[tags=customer]
----
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/quickstart/Example.java[tags=address]
----
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/quickstart/Example.java[tags=customerAddress]
----
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/quickstart/Example.java[tags=domainModelTest]
----
