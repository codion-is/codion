...
|JavaFX|is.codion:codion-javafx-framework:{codion-version}
|===
...
== Gradle
A minimal Gradle dependencies clause for a Swing based client application, based on an H2 database.
...
|is.codion.framework.db.core|is.codion:codion-framework-db-core:{codion-version}|Database API
|is.codion.framework.db.local|is.codion:codion-framework-db-local:{codion-version}|Local JDBC
|===
