...
If you use Logback, Log4J or Java Util Logging you can use one of the logging-proxy plugins below which will pull in the required dependencies and provide actions in the client *Help -> Log* menu for setting the log level and opening the log file/directory (if available).
...
----
include::{dir-source}/is/codion/manual/app/quickstart/Store.java[tags=store]
----
====
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/app/quickstart/Store.java[tags=storeDomain]
----
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/app/quickstart/Store.java[tags=customerApi]
----
...
We supply these *ColumnDefinition.Builder* instances to the *EntityType.as()* method, which returns a *EntityDefinition.Builder* instance, providing further configuration options for the entity definition, such as the key generation strategy. Finally, we build the *EntityDefinition* and return it.

[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/app/quickstart/Store.java[tags=customerImpl]
----
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/app/quickstart/Store.java[tags=address]
----
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/app/quickstart/Store.java[tags=customerAddress]
----
...
----
include::{dir-source}/is/codion/manual/app/quickstart/Example.java[tags=customerEditPanel]
----

We build an *EntityConnection* used when we create a *SwingEntityModel* based on the *Customer* entity.

We create an instance of our *CustomerEditPanel* and use it along with the model to create a *EntityPanel*.

[source,java,indent=0,options="nowrap"]
----
include::{dir-source}/is/codion/manual/app/quickstart/Example.java[tags=customerPanel]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{dir-source}/is/codion/manual/app/quickstart/Example.java[tags=addressEditPanel]
----
...
[source,java,indent=0,options="nowrap"]
----
include::{dir-source}/is/codion/manual/app/quickstart/Example.java[tags=detailPanel]
----
...
[source,java,indent=0]
----
include::{dir-test-source}/is/codion/manual/app/quickstart/StoreTest.java[tags=domainModelTest]
----
...
|is.codion.framework.db|is.codion:codion-framework-db:{codion-version}|Core database API
...
[source,java,indent=0,options="nowrap"]
----
include::{dir-source}/is/codion/manual/app/quickstart/Example.java[tags=select]
----
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/app/quickstart/Example.java[tags=persist]
----
...
[source,java,indent=0]
----
include::{dir-source}/is/codion/manual/app/quickstart/Example.java[tag=**]
----
====