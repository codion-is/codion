...
|Swing|dev.codion.{jminor-jdk}:jminor-swing-framework.ui:{jminor-version}
|JavaFX|dev.codion.{jminor-jdk}:jminor-javafx-framework:{jminor-version}
|===
...
|Local|dev.codion.{jminor-jdk}:jminor-framework-db-local:{jminor-version}
|RMI|dev.codion.{jminor-jdk}:jminor-framework-db-rmi:{jminor-version}
|HTTP|dev.codion.{jminor-jdk}:jminor-framework-db-http:{jminor-version}
|===
...
|Derby|dev.codion.{jminor-jdk}:jminor-dbms-derby:{jminor-version}
|H2 Database|dev.codion.{jminor-jdk}:jminor-dbms-h2database:{jminor-version}
|HSQL|dev.codion.{jminor-jdk}:jminor-dbms-hsql:{jminor-version}
|MariaDB|dev.codion.{jminor-jdk}:jminor-dbms-mariadb:{jminor-version}
|MySQL|dev.codion.{jminor-jdk}:jminor-dbms-mysql:{jminor-version}
|Oracle|dev.codion.{jminor-jdk}:jminor-dbms-oracle:{jminor-version}
|Postgresql|dev.codion.{jminor-jdk}:jminor-dbms-postgresql:{jminor-version}
|SQLite|dev.codion.{jminor-jdk}:jminor-dbms-sqlite:{jminor-version}
|SQL Server|dev.codion.{jminor-jdk}:jminor-dbms-sqlserver:{jminor-version}
|===
...
|Logback|dev.codion.{jminor-jdk}:jminor-plugin-logback-proxy:{jminor-version}
|Log4j|dev.codion.{jminor-jdk}:jminor-plugin-log4j-proxy:{jminor-version}
|Java Util Logging|dev.codion.{jminor-jdk}:jminor-plugin-jul-proxy:{jminor-version}
|===
...
dependencies {
    ...
    implementation 'dev.codion.{jminor-jdk}:jminor-swing-framework-ui:{jminor-version}'

    //JSON for persisting client preferences
    runtimeOnly 'dev.codion.{jminor-jdk}:jminor-plugin-json:{jminor-version}'
    //Local JDBC connection module
    runtimeOnly 'dev.codion.{jminor-jdk}:jminor-framework-db-local:{jminor-version}'
    //H2 DBMS module
    runtimeOnly 'dev.codion.{jminor-jdk}:jminor-dbms-h2database:{jminor-version}'
    //H2 JDBC driver
    runtimeOnly 'com.h2database:h2:1.4.200'
    //Logging with Logback
    runtimeOnly 'dev.codion.{jminor-jdk}:jminor-plugin-logback-proxy:{jminor-version}'

    //Domain model unit testing module
    testImplementation 'dev.codion.{jminor-jdk}:jminor-framework-domain-test:{jminor-version}'
    //JUnit 5
...
|===
|Module|Artifact
|dev.codion.framework.domain|dev.codion.{jminor-jdk}:jminor-framework-domain:{jminor-version}
|===
...
|===
|Module|Artifact
|dev.codion.swing.framework.ui|dev.codion.{jminor-jdk}:jminor-swing-framework-ui:{jminor-version}
|===
...
|===
|Module|Artifact
|dev.codion.framework.domain.test|dev.codion.{jminor-jdk}:jminor-framework-domain-test:{jminor-version}
|===
...
|dev.codion.framework.db.core|dev.codion.{jminor-jdk}:jminor-framework-db-core:{jminor-version}|Database API
|dev.codion.framework.db.local|dev.codion.{jminor-jdk}:jminor-framework-db-local:{jminor-version}|Local JDBC
|===
