...
|RMI|org.jminor.{jminor-jdk}:jminor-framework-db-rmi:{jminor-version}
...
|MariaDB|org.jminor.{jminor-jdk}:jminor-dbms-mariadb:{jminor-version}
...
|===
|Module|Artifact
|org.jminor.framework.domain.test|org.jminor.{jminor-jdk}:jminor-framework-domain-test:{jminor-version}
|===
...
[source,java,indent=0]
----
include::{dir-source}/org/jminor/framework/demos/manual/quickstart/Example.java[tag=**]
----
====