...
NOTE: In this example the constants contain the actual table and column names, but these can be specified via the builder if that is preferred (see manual).
