...
=== is/codion/common/db/exception/DatabaseException.java

[source]
----
is/codion/common/db/exception/DatabaseException.properties
is/codion/common/db/exception/DatabaseException_is_IS.properties
----
...
|account_locked|This account is locked|Aðgangurinn er læstur
|authentication|Invalid username or password|Rangt notendanafn eða lykilorð
|check_constraint|The value or values attempted to be entered in a field or fields violate a defined check constraint|Óleyfilegt gildi
|child_exists|This record is referenced by records in other tables, delete those first|Vísað er í þessa færslu úr öðrum töflum, eyddu þeim færslum fyrst
|missing_privileges|You are not authorized to perform this action|Þig vantar réttindi til að framkvæma umbeðna aðgerð
|null_value|Value missing|Gildi vantar
|parent_missing|A foreign key value has no matching primary key value|Reynt var að vísa í færslu sem ekki er til
|password_expired|The password has expired|Lykilorðið er útrunnið
|referential_integrity|The operation violates a foreign key constraint|Aðgerðin uppfyllir ekki kröfur um tengingar milli færsnla
|row_locked|This record is being modified by another user|Annar notandi er að breyta þessari færslu
|table_not_found|Table or view does not exist|Tafla eða view finnst ekki
|timeout|The operation timed out|Aðgerðin rann út á tíma
|unique_constraint|This combination of values already exists|Þessi samsetning gilda er nú þegar til í töflunni
|value_too_large|The value entered is larger than the maximum defined for the column|Gildi er of stórt fyrir dálk
|===
...
=== is/codion/common/utilities/Operator.java

[source]
----
is/codion/common/utilities/Operator.properties
is/codion/common/utilities/Operator_is_IS.properties
----
...
=== is/codion/framework/db/exception/EntityModifiedException.java

[source]
----
is/codion/framework/db/exception/EntityModifiedException.properties
is/codion/framework/db/exception/EntityModifiedException_is_IS.properties
----
...
=== is/codion/framework/db/exception/EntityNotFoundException.java

[source]
----
is/codion/framework/db/exception/EntityNotFoundException.properties
is/codion/framework/db/exception/EntityNotFoundException_is_IS.properties
----
...
=== is/codion/framework/db/exception/MultipleEntitiesFoundException.java

[source]
----
is/codion/framework/db/exception/MultipleEntitiesFoundException.properties
is/codion/framework/db/exception/MultipleEntitiesFoundException_is_IS.properties
----
...
=== is/codion/framework/domain/entity/attribute/AbstractValueAttributeDefinition.java

[source]
----
is/codion/framework/domain/entity/attribute/AbstractValueAttributeDefinition.properties
is/codion/framework/domain/entity/attribute/AbstractValueAttributeDefinition_is_IS.properties
----
...
|add|Add|Ný færsla
|add_mnemonic|A|A
|add_tip|Add a new record|Skrá nýja færslu
...
|edit|Edit|Breyta
|edit_attribute_tip|Edit value|Breyta gildi
|edit_mnemonic|E|B
|edit_selected_tip|Edit selected record|Breyta valinni færslu
|exit|Exit|Hætta
|exit_mnemonic|X|Æ
...
=== is/codion/swing/common/ui/component/image/ImagePane.java

[source]
----
is/codion/swing/common/ui/component/image/ImagePane.properties
is/codion/swing/common/ui/component/image/ImagePane_is_IS.properties
----
...
=== is/codion/swing/common/ui/component/logging/LogLevelPanel.java

[source]
----
is/codion/swing/common/ui/component/logging/LogLevelPanel.properties
is/codion/swing/common/ui/component/logging/LogLevelPanel_is_IS.properties
----
...
|level|Level|Nákvæmni
|logger|Logger|Loggur
|===

=== is/codion/swing/common/ui/component/logging/LogViewer.java

[source]
----
is/codion/swing/common/ui/component/logging/LogViewer.properties
is/codion/swing/common/ui/component/logging/LogViewer_is_IS.properties
----
...
|line_wrap|Line wrap|Skipta línum
|save_to_file|Save to file|Vista í skrá
|===
...
|copy_column|Copy Column|Afrita Dálk
...
|value_above_maximum|Value may not exceed|Gildið má ekki vera hærra en
|value_below_minimum|Value may not be less than|Gildið má ekki vera lægra en
|===
...
=== is/codion/swing/common/ui/component/text/TextInput.java

[source]
----
is/codion/swing/common/ui/component/text/TextInput.properties
is/codion/swing/common/ui/component/text/TextInput_is_IS.properties
----
...
|file_exists|File exists|Skrá er til
...
|dark|Dark|Dökk
|dark_mnemonic|D|D
|include|Include|Sýna
|light|Light|Ljós
|light_mnemonic|L|L
|look_and_feel|Look & Feel|Útlit
|platform|Platform|Innbyggð
|platform_mnemonic|P|I
|===
...
=== is/codion/swing/framework/ui/EntityApplication.java

[source]
----
is/codion/swing/framework/ui/EntityApplication.properties
is/codion/swing/framework/ui/EntityApplication_is_IS.properties
----
...
|advanced_log_level|Advanced|Fínstilla
|advanced_log_level_mnemonic|A|F
...
|shortcuts|Shortcuts|Flýtilyklar
|sql_tracing|SQL Trace|SQL Rakning
|sql_tracing_enabled|Enabled|Virk
|system_properties|System properties|Kerfisstillingar
|tools|Tools|Tól
|tools_mnemonic|T|T
|view_sql_trace|View|Skoða
|===
...
|fetching_dependencies|Fetching dependencies|Sæki tengdar færslur
...
=== is/codion/swing/framework/ui/EntityTableExportPanel.java

[source]
----
is/codion/swing/framework/ui/EntityTableExportPanel.properties
is/codion/swing/framework/ui/EntityTableExportPanel_is_IS.properties
----
...
|columns_all|All|Alla
|columns_all_mnemonic|L|L
|columns_default|Default|Sjálfgefnir
|columns_default_mnemonic|D|G
|columns_none|None|Enga
|columns_none_mnemonic|N|E
|configuration_file|Configuration file|Stilliskrá
|configurations|Configurations|Stillingar
|data_exported|Data exported|Gögn afrituð
|excluded|Excluded|Ónotaðir
|export|Export|Flytja út
|exported_to_clipboard|Exported to clipboard|Afritað á klippiborð
|exported_to_file|Exported to file|Afritað í skrá
|exporting_data|Exporting data|Flyt út gögn
|help|Help|Hjálp
|help_text|Use ALT-click or space to toggle included columns, SHIFT-space to toggle subcolumns.

Use ALT-Up/Down arrows to move the included columns.|Notið ALT-smella eða stafabil til að velja/afvelja dílka, SHIFT-stafabil til að velja/afvelja undirdálka.

Notið ALT-Upp/Niður örvar til að færa valda dílka.
|hide_excluded|Hide|Fela
|hide_excluded_mnemonic|D|F
|include|Include|Velja
|move|Move|Færa
|rows_all|All rows|Allar færslur
|rows_all_mnemonic|A|A
|rows_selected|Selected rows|Valdar færslur
|rows_selected_mnemonic|E|R
|show_excluded|Show|Sýna
|show_excluded_mnemonic|W|N
|show_hidden|Show hidden columns|Birta falda dálka
|show_hidden_mnemonic|H|B
|to_clipboard|To clipboard|Á klippiborð
|to_clipboard_mnemonic|P|P
|to_file|To file|Í skrá
|to_file_mnemonic|F|S
|===
...
|add_next_to_selection|Add next to selection|Bæta næstu við val
|add_previous_to_selection|Add previous to selection|Bæta síðustu við val
...
|copy_selected_column|Copy selected column cells to clipboard|Afrita reiti valins dálks á klippiborð
...
|increment_decrement|Increment/decrement based to cursor position|Hækka/lækka út frá staðsetningu bendils
...
|select_next|Select next|Velja næstu
|select_previous|Select previous|Velja síðustu
|show_popup_menu|Show popup menu|Birta valmynd
|table_export|Table export|Töfluafritun
...
|toggle_include_attribute|Toggle attribute inclusion|Velja/afvelja gildi
|toggle_search_result_selection|Toggle result selection|Velja/afvelja leitarniðurstöðu
...
|update|Update|Uppfæra
|view_selected_item|View selected item|Skoða valda færslu
|===
...
=== is/codion/tools/swing/robot/Narrator.java

[source]
----
is/codion/tools/swing/robot/Narrator.properties
is/codion/tools/swing/robot/Narrator_is_IS.properties
----
...
|description|Description|Skýring
|keystrokes|Keystrokes|Lyklaborð
|narration|Narration|Lýsing
|narrator|Narrator|Þulur
|===