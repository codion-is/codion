...
|copied_to_clipboard|Copied to clipboard|Afritað á klippiborð
|copied_to_file|Copied to file|Afritað í skrá
|copying_data|Copying data|Afrita gögn
|data_copied|Data copied|Gögn afrituð
