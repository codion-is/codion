...
|exporting_data|Exporting data|Afrita gögn
|help|Help|Hjálp
|help_text|Use ALT-click or space to toggle selected columns, SHIFT-space to toggle subcolumns.

Use ALT-Up/Down arrows to move the selected columns.|Notið ALT-smella eða stafabil til að velja/afvelja valda dálka, SHIFT-stafabil til að velja/afvelja undirdálka.
...
|export_data|Export Data|Afrita Gögn
