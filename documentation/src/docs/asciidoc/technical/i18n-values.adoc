...
=== is/codion/swing/framework/ui/DefaultEntityApplication.java

[source]
----
is/codion/swing/framework/ui/DefaultEntityApplication.properties
is/codion/swing/framework/ui/DefaultEntityApplication_is_IS.properties
----
