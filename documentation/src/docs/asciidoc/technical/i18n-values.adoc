...
=== is/codion/swing/common/ui/component/image/ImagePanel.java

[source]
----
is/codion/swing/common/ui/component/image/ImagePanel.properties
is/codion/swing/common/ui/component/image/ImagePanel_is_IS.properties
----
