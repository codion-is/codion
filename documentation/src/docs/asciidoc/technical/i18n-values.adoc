...
=== is/codion/common/model/condition/ConditionModel$AutomaticWildcard.java

[source]
----
is/codion/common/model/condition/ConditionModel$AutomaticWildcard.properties
is/codion/common/model/condition/ConditionModel$AutomaticWildcard_is_IS.properties
----
...
=== is/codion/swing/common/ui/component/table/TableConditionsPanel.java

[source]
----
is/codion/swing/common/ui/component/table/TableConditionsPanel.properties
is/codion/swing/common/ui/component/table/TableConditionsPanel_is_IS.properties
----
