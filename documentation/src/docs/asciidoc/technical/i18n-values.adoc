...
=== is/codion/swing/common/ui/component/logging/LogViewerPanel.java

[source]
----
is/codion/swing/common/ui/component/logging/LogViewerPanel.properties
is/codion/swing/common/ui/component/logging/LogViewerPanel_is_IS.properties
----
...
|tools|Tools|Tól
|tools_mnemonic|T|T
|tracing|Tracing|Rakning
|tracing_enabled|Enabled|Virk
|view_application_tree|Application Tree|Yfirlitsmynd
|view_trace|View|Skoða
|===
