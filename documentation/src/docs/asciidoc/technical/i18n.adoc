...
|confirm_insert|Insert?|Vista?
|confirm_update|Update selected?|Uppfæra valdar?
...
|file_mnemonic|F|K
|filter|Filter|Sýja
|no_results_found|No results found|Leit skilaði engum niðurstöðum
|refresh_all|Refresh All|Endurhlaða Öllu
|save|Save|Vista
|save_mnemonic|S|V
|search|Search|Leita
|search_mnemonic|S|T
