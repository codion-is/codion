...
[source,java]
----
include::{dir-source}/dev/codion/framework/demos/chinook/tutorial/ClientArchitecture.java[tags=entityModel]
----
...
[source,java]
----
include::{dir-source}/dev/codion/framework/demos/chinook/tutorial/ClientArchitecture.java[tags=entityPanel]
----
...
[source,java]
----
include::{dir-source}/dev/codion/framework/demos/chinook/tutorial/ClientArchitecture.java[lines=4..-1]
----
====
