...
|CRUD|JSON|JSON
|{url-javadoc}{framework-db}/is/codion/framework/db/EntityConnection.html#execute(is.codion.common.db.operation.FunctionType)[Functions]|JSON|Java serialization
|{url-javadoc}{framework-db}/is/codion/framework/db/EntityConnection.html#execute(is.codion.common.db.operation.ProcedureType)[Procedures]|JSON|N/A
|{url-javadoc}{framework-db}/is/codion/framework/db/EntityConnection.html#report(is.codion.common.db.report.ReportType,P)[Reports]|JSON|Java serialization
