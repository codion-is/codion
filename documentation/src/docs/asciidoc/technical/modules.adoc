...
* {url-javadoc}{framework-db-core}/is/codion/framework/db/criteria/package-summary.html[is.codion.framework.db.criteria]
...
[%collapsible]
====
image::modules/swing/common-model-tools/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
...
[%collapsible]
====
image::modules/swing/common-ui-tools/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
...
[%collapsible]
====
image::modules/swing/framework-model-tools/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
...
[%collapsible]
====
image::modules/swing/framework-ui-tools/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
