...
[%collapsible]
====
image::modules/swing/common-loadtest-model/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
...
[%collapsible]
====
image::modules/swing/common-loadtest-ui/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
...
[%collapsible]
====
image::modules/swing/framework-generator-model/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
...
[%collapsible]
====
image::modules/swing/framework-generator-ui/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
