...
[%collapsible]
====
image::modules/framework/lambda/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
...
[%collapsible]
====
image::modules/plugins/swing-robot/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
