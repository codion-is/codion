...
[%collapsible]
====
image::modules/tools/server-monitor/model/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
...
[%collapsible]
====
image::modules/tools/server-monitor/ui/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
