...
[discrete]
=== codion-swing-common-loadtest-model

.Dependency graph
[%collapsible]
====
image::modules/tools/common-loadtest-model/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====

[discrete]
=== codion-swing-common-loadtest-ui

.Dependency graph
[%collapsible]
====
image::modules/tools/common-loadtest-ui/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
...
[discrete]
=== codion-swing-framework-generator-model

.Dependency graph
[%collapsible]
====
image::modules/tools/framework-generator-model/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====

[discrete]
=== codion-swing-framework-generator-ui

.Dependency graph
[%collapsible]
====
image::modules/tools/framework-generator-ui/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
...
[%collapsible]
====
image::modules/tools/framework-server-monitor/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
