...
[source,java]
----
include::{dir-manual-source}/is/codion/manual/design/DesignAndStyleDemo.java[tags=factories,indent=0]
----
...
[source,java]
----
include::{dir-manual-source}/is/codion/manual/design/DesignAndStyleDemo.java[tags=builders,indent=0]
----
...
[source,java]
----
include::{dir-manual-source}/is/codion/manual/design/DesignAndStyleDemo.java[tags=accessors,indent=0]
----
...
Many classes expose their internal state via the {url-javadoc}{common-reactive}/is/codion/common/reactive/value/Value.html[Value] class, which can be used to mutate the associated state or observe it by adding listeners or consumers.

[source,java]
----
include::{dir-manual-source}/is/codion/manual/design/DesignAndStyleDemo.java[tags=mutable,indent=0]
----
...
[source,java]
----
include::{dir-manual-source}/is/codion/manual/design/DesignAndStyleDemo.java[tags=exceptions,indent=0]
----