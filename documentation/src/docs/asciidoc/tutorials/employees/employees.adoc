...
We call the *initializeComboBoxModels* method in order to populate a couple of combo box models, otherwise that will happen on the EDT when the associated combo boxes are created.
