...
[source,java]
----
include::{dir-source}/is/codion/demos/employees/model/EmployeeEditModel.java[tags=createForeignKeyComboBox]
----
...
[source,java]
----
include::{dir-source}/is/codion/demos/employees/ui/EmployeeTablePanel.java[]
----
