...
Here we also introduce the <<{basedir}/manual/manual.adoc#_foreignkey, ForeignKey>>, the *orderBy*, as well as a *CellColor* which is responsible for providing a custom color for an entity instance.
