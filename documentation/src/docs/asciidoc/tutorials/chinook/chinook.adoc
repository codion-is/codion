...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/chinook/model/EmployeeTableModel.java[lines=19..-1]
----
...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/chinook/ui/ArtistPanel.java[lines=19..-1]
----
...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/chinook/ui/MinutesSecondsPanelValue.java[lines=19..-1]
----
...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/chinook/ui/TrackSelectionProvider.java[lines=19..-1]
----
...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/chinook/server/ChinookLoginProxy.java[lines=19..-1]
----
