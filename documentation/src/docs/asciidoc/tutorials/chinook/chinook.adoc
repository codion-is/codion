...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/chinook/model/EmployeeEditModel.java[lines=4..-1]
----
...
[source,java]
----
include::{dir-test-source}/is/codion/framework/demos/chinook/model/InvoiceLineEditModelTest.java[lines=4..-1]
----
...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/chinook/ui/AlbumPanel.java[lines=4..-1]
----
...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/chinook/ui/TrackSelectorFactory.java[lines=4..-1]
----
...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/chinook/server/ChinookAuthenticator.java[lines=4..-1]
----
...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/chinook/testing/scenarios/LoadTestUtil.java[lines=4..-1]
----
