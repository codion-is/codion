...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/chinook/model/AlbumTableModel.java[lines=4..-1]
----
...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/chinook/ui/ChinookComponentValues.java[lines=4..-1]
----
...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/chinook/testing/scenarios/UpdateTotalsPrices.java[lines=4..-1]
----
