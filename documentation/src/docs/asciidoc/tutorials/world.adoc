...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/world/domain/World.java[tag=**]
----
...
[source,java]
----
include::{dir-test-source}/is/codion/framework/demos/world/domain/WorldTest.java[tag=**]
----
...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/world/model/CountryCustomModel.java[tag=**]
----
...
[source,java]
----
include::{dir-source}/is/codion/framework/demos/world/ui/CountryCustomPanel.java[tag=**]
----
