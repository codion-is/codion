...
We override *createToolsControls()* to add our import action to the Tools menu.

[source,java]
----
include::{dir-source}/is/codion/framework/demos/empdept/ui/EmpDeptAppPanel.java[tags=createToolsControls]
----
