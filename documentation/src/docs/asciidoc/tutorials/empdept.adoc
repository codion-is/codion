...
We create a main application model by extending {url-javadoc}{swing-framework-ui}/is/codion/swing/framework/model/SwingEntityApplicationModel.html[SwingEntityApplicationModel] and add an entity model for the department entity.
