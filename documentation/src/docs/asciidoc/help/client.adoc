...
By default, condition operators are set to *EQUAL*, to change the operator you can use the kbd:[Ctrl + UP / DOWN] keyboard shortcut (the operator is displayed in a tooltip) or switch to the *advanced* search panel view, see below.
...
This clears all values and resets all operators to their default, *EQUAL*.
