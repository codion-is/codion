...
public final class TestDomain {
  ...
  public static final String T_MASTER = "server.monitor.master_entity";
  ...
  public static final String DETAIL_SELECT_TABLE_NAME = "server.monitor.entity_test_select";

  @Entity.Table(orderByClause = DETAIL_STRING, selectTableName = DETAIL_SELECT_TABLE_NAME)
  public static final String T_DETAIL = "server.monitor.detail_entity";
  ...
  public static final String SCOTT_DOMAIN_ID = "server.monitor.scott.domain";
  ...
  public static final String T_DEPARTMENT = "server.monitor.scott.dept";
  ...
  @Property.Column(entityID = "server.monitor.scott.emp", columnName = "empno")
  public static final String EMP_ID = "emp_id";
  @Property.Column(entityID = "server.monitor.scott.emp", columnName = "ename")
  ...
  public static final String T_EMP = "server.monitor.scott.emp";
