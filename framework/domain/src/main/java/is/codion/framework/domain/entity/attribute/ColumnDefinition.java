...
public sealed interface ColumnDefinition<T> extends ValueAttributeDefinition<T> permits DefaultColumnDefinition {
	...
	/**
	 * @return true if the value of this column is generated.
	 * @see ColumnDefinition.Builder#generator(Generator)
	 */
	boolean generated();

	/**
	 * @return the {@link Generator} used to populate the value of this column
	 * @throws IllegalStateException in case a generator is not available
	 * @see #generated()
	 */
