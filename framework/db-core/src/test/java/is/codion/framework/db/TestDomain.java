...
public final class TestDomain extends Domain {
  ...
  public static final EntityType T_SUPER = type("db.super_entity");
  ...
  public static final EntityType T_MASTER = type("db.master_entity");
  ...
  public static final EntityType T_DETAIL = type("db.detail_entity");
  ...
  public static final EntityType DETAIL_SELECT_TABLE_NAME = type("db.entity_test_select");
  ...
  public static final EntityType T_DEPARTMENT = type("db.scott.dept");
  ...
  public static final EntityType T_EMP = type("db.scott.emp");
