...
public final class TestDomain extends Domain {
  ...
  public static final EntityId T_SUPER = entityId("db.super_entity");
  ...
  public static final EntityId T_MASTER = entityId("db.master_entity");
  ...
  public static final EntityId T_DETAIL = entityId("db.detail_entity");
  ...
  public static final EntityId DETAIL_SELECT_TABLE_NAME = entityId("db.entity_test_select");
  ...
  public static final EntityId T_DEPARTMENT = entityId("db.scott.dept");
  ...
  public static final EntityId T_EMP = entityId("db.scott.emp");
