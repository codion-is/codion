...
public final class TestDomain extends Domain {
  ...
  public static final Entity.Identity T_SUPER = entityIdentity("db.super_entity");
  ...
  public static final Entity.Identity T_MASTER = entityIdentity("db.master_entity");
  ...
  public static final Entity.Identity T_DETAIL = entityIdentity("db.detail_entity");
  ...
  public static final Entity.Identity DETAIL_SELECT_TABLE_NAME = entityIdentity("db.entity_test_select");
  ...
  public static final Entity.Identity T_DEPARTMENT = entityIdentity("db.scott.dept");
  ...
  public static final Entity.Identity T_EMP = entityIdentity("db.scott.emp");
