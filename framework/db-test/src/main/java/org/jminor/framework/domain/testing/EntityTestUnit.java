...
public class EntityTestUnit {
   ...
   */
  public static Entity createEntity(final Entities domain, final String entityId, final ValueProvider<Property, Object> valueProvider) {
   ...
   */
  public static Entity randomize(final Entities domain, final Entity entity, final boolean includePrimaryKey,
  ...
  private static void populateEntity(final Entities domain, final Entity entity, final Collection<Property.ColumnProperty> properties,
