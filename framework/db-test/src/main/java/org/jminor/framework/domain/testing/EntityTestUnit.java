...
public class EntityTestUnit {
  ...
  public static Entity createRandomEntity(final Entities entities, final String entityId, final Map<String, Entity> referenceEntities) {
    return createEntity(entities, entityId, property -> getRandomValue(property, referenceEntities));
  }
   ...
   */
  public static Entity createEntity(final Entities entities, final String entityId, final ValueProvider<Property, Object> valueProvider) {
    final Entity entity = entities.entity(entityId);
    populateEntity(entities, entity, entities.getColumnProperties(entityId, !entities.isPrimaryKeyAutoGenerated(entityId),
   ...
   */
  public static Entity randomize(final Entities entities, final Entity entity, final boolean includePrimaryKey,
                                 final Map<String, Entity> referenceEntities) {
    Objects.requireNonNull(entity, ENTITY_PARAM);
    populateEntity(entities, entity, entities.getColumnProperties(entity.getEntityId(), includePrimaryKey, false, true),
  ...
  private static void populateEntity(final Entities entities, final Entity entity, final Collection<Property.ColumnProperty> properties,
