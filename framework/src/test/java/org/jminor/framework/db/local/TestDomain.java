...
public final class TestDomain {
  ...
  public static final String T_MASTER = "local.master_entity";
  ...
  public static final String DETAIL_SELECT_TABLE_NAME = "local.entity_test_select";

  @Entity.Table(orderByClause = DETAIL_STRING, selectTableName = DETAIL_SELECT_TABLE_NAME)
  public static final String T_DETAIL = "local.detail_entity";
  ...
  public static final String SCOTT_DOMAIN_ID = "local.scott.domain";
  ...
  public static final String T_DEPARTMENT = "local.scott.dept";
  ...
  @Property.Column(entityID = "local.scott.emp", columnName = "empno")
  public static final String EMP_ID = "emp_id";
  @Property.Column(entityID = "local.scott.emp", columnName = "ename")
  ...
  public static final String T_EMP = "local.scott.emp";
