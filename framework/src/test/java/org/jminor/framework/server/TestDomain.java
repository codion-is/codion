...
public final class TestDomain {
  ...
  public static final String T_MASTER = "server.master_entity";
  ...
  public static final String DETAIL_SELECT_TABLE_NAME = "server.entity_test_select";

  @Entity.Table(orderByClause = DETAIL_STRING, selectTableName = DETAIL_SELECT_TABLE_NAME)
  public static final String T_DETAIL = "server.detail_entity";
  ...
  public static final String SCOTT_DOMAIN_ID = "server.scott.domain";
  ...
  public static final String T_DEPARTMENT = "server.scott.dept";
  ...
  @Property.Column(entityID = "server.scott.emp", columnName = "empno")
  public static final String EMP_ID = "emp_id";
  @Property.Column(entityID = "server.scott.emp", columnName = "ename")
  ...
  public static final String T_EMP = "server.scott.emp";
