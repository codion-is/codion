...
public final class Configuration {
   ...
   * Default value: false
   */
  public static final String TABLE_CONDITION_PANEL_VISIBLE = "jminor.client.tableConditionPanelVisible";
  ...
  static {
    ...
    PROPERTIES.put(TABLE_CONDITION_PANEL_VISIBLE, false);
  ...
  private static void parseSystemSettings() {
    ...
    parseBooleanProperty(TABLE_CONDITION_PANEL_VISIBLE, PROPERTIES);
