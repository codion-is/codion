...
/**
 * The {@link EntityConnection} running on the server, as exported to clients over RMI.
 * <p>
 * This is the wire contract, adapted to {@link EntityConnection} on the client side by
 * {@link RemoteEntityConnection}. Each method mirrors its {@link EntityConnection} counterpart, adding
 * {@link RemoteException}; refer to {@link EntityConnection} for the behavioral contract.
 * <p>
 * Note that this interface can not extend {@link EntityConnection}, RMI requiring every method on a
 * {@link Remote} interface to declare {@link RemoteException}.
 */
public interface ServerEntityConnection extends Remote, AutoCloseable {
	 ...
	 * <p>Empty unless this connection manages itself, a raw connection knowing nothing of how it was configured.
	 * @return a description of this connection, an empty {@link Optional} if none is available
	 * @throws RemoteException in case of an exception
	 */
	default Optional<String> description() throws RemoteException {
		return Optional.empty();
	}

	/**
	 * Returns the version of the client this connection belongs to, as reported to the server.
	 * <p>Empty unless this connection manages itself.
	 * @return the client version, an empty {@link Optional} if none was specified
	 * @throws RemoteException in case of an exception
	 */
	default Optional<Version> clientVersion() throws RemoteException {
		return Optional.empty();
	}
	 ...
	 */
	<P, R> R report(ReportType<P, R> reportType, @Nullable P parameter) throws RemoteException;
	 ...
	 */
	ServerEntityResultIterator iterator(Condition condition) throws RemoteException;
	 ...
	 */
	ServerEntityResultIterator iterator(Select select) throws RemoteException;
	 ...
	 * @see #iterator(Select)
	 */
	default ServerEntityResultIterator iterator(Supplier<Select> select) throws RemoteException {
