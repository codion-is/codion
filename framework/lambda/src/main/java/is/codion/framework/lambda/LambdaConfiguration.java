...
public final class LambdaConfiguration {
	...
	private static final String DEFAULT_DEFAULT_USER = "lambda:lambda";
	...
	/**
	 * @return the default user for unauthenticated requests
	 */
	public User defaultUser() {
		return User.parse(environment.getOrDefault(DEFAULT_USER, DEFAULT_DEFAULT_USER));
	}
	 ...
	 * @return the authenticated user or default user
	 */
