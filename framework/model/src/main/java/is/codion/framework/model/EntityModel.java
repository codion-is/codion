...
public interface EntityModel<M extends EntityModel<M, E, T>, E extends EntityEditModel, T extends EntityTableModel<E>>
   ...
   */
  void initialize(EntityType<? extends Entity> foreignKeyEntityType, List<Entity> foreignKeyValues);
   ...
   */
  boolean containsDetailModel(EntityType<? extends Entity> entityType);
   ...
   */
  M getDetailModel(EntityType<? extends Entity> entityType);
