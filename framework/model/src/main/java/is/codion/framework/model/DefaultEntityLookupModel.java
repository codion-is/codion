...
public final class DefaultEntityLookupModel implements EntityLookupModel {
   ...
   */
  public DefaultEntityLookupModel(final Identity entityId, final EntityConnectionProvider connectionProvider) {
  ...
  private static void validateLookupProperties(final Identity entityId, final Collection<ColumnProperty<?>> lookupProperties) {
    for (final ColumnProperty<?> property : lookupProperties) {
