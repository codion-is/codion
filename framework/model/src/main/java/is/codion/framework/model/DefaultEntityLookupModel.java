...
public final class DefaultEntityLookupModel implements EntityLookupModel {
   ...
   */
  public DefaultEntityLookupModel(final EntityIdentity entityId, final EntityConnectionProvider connectionProvider) {
  ...
  private static void validateLookupProperties(final EntityIdentity entityId, final Collection<ColumnProperty<?>> lookupProperties) {
    for (final ColumnProperty<?> property : lookupProperties) {
