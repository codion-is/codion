...
public final class DefaultEntityLookupModel implements EntityLookupModel {
   ...
   */
  public DefaultEntityLookupModel(final EntityType<? extends Entity> entityType, final EntityConnectionProvider connectionProvider) {
  ...
  private static void validateLookupProperties(final EntityType<? extends Entity> entityType, final Collection<ColumnProperty<?>> lookupProperties) {
    for (final ColumnProperty<?> property : lookupProperties) {
