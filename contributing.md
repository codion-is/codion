...
**Pull request creation is restricted to repository collaborators.** If you attempt to open one, GitHub will tell you that pull requests are limited to collaborators — this is intentional, not a bug.
