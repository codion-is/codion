...
public class EntityUtil {
  ...
  public static Entity createRandomEntity(final String entityID, final Map<String, Entity> referenceEntities) {
    return createEntity(entityID, new ValueProvider() {
      public Object getValue(final Object key) {
        return getRandomValue((Property) key, referenceEntities);
      }
    });
  }

  public static Entity createEntity(final String entityID, final ValueProvider valueProvider) {
    ...
    for (final Property property : EntityRepository.getDatabaseProperties(entityID, !autoGenID, false, true)) {
      if (!property.hasParentProperty())
        entity.setValue(property, valueProvider.getValue(property), false);
    }
