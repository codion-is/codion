...
public final class EntityUtil {
  ...
  public static List<Property> getUpdatableProperties(final String entityID) {
    final List<Property.ColumnProperty> columnProperties = EntityRepository.getColumnProperties(entityID,
    ...
    updatable.addAll(EntityRepository.getForeignKeyProperties(entityID));
    sort(updatable);
