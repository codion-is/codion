 ...
 */
public interface EntityDbRemote extends Remote {
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  List<Object> executeFunction(final String functionID, final List<Object> arguments) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  void executeProcedure(final String procedureID, final List<Object> arguments) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  List<Entity.Key> insert(final List<Entity> entities) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  List<Entity> update(final List<Entity> entities) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  void delete(final List<Entity.Key> entityKeys) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  void delete(final EntityCriteria criteria) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  Entity selectSingle(final String entityID, final String propertyID, final Object value) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  Entity selectSingle(final Entity.Key key) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  Entity selectSingle(final EntitySelectCriteria criteria) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  List<Entity> selectMany(final List<Entity.Key> keys) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  List<Entity> selectMany(final EntitySelectCriteria criteria) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  List<Entity> selectMany(final String entityID, final String propertyID, final Object... values) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  List<Entity> selectAll(final String entityID) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  Map<String, Collection<Entity>> selectDependentEntities(final Collection<Entity> entities) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  int selectRowCount(final EntityCriteria criteria) throws RemoteException, DbException;
   ...
   */
  ReportResult fillReport(final ReportWrapper reportWrapper) throws RemoteException, DbException, ReportException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  List<List> selectRows(final String statement, final int fetchCount) throws RemoteException, DbException;
  ...
  void writeBlob(final Entity.Key primaryKey, final String blobPropertyID, final String dataDescription,
                 final byte[] blobData) throws RemoteException, DbException;
   ...
   * @throws java.rmi.RemoteException in case of a remote exception
   */
  byte[] readBlob(final Entity.Key primaryKey, final String blobPropertyID) throws RemoteException, DbException;
}
