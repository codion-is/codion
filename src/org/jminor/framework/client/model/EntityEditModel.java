...
public class EntityEditModel extends ValueChangeMapEditModel<String, Object> {
   ...
   */
  @Override
  public boolean isNullable(final ValueChangeMap<String, Object> entity, final String propertyID) {
    return EntityRepository.getProperty(getEntityID(), propertyID).isNullable();
  }
