...
public class EntityEditModel {
  ...
  protected void performRangeValidation(final Entity entity, final Property property) throws ValidationException {
  ...
  protected void performNullValidation(final Entity entity, final Property property, final int action) throws ValidationException {
