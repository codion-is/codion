...
public class DefaultEntityEditModel extends AbstractValueChangeMapEditModel<String, Object> implements EntityEditModel {
  ...
  /** {@inheritDoc} */
  public final List<Entity.Key> insert() throws DatabaseException, ValidationException {
  ...
  /** {@inheritDoc} */
  public final List<Entity.Key> insert(final List<Entity> entities) throws DatabaseException, ValidationException {
