...
public class DefaultEntityTableCriteriaModel implements EntityTableCriteriaModel {
   ...
   * foreign key properties assumed to belong to the entity identified by <code>entityID</code>
   */
  public DefaultEntityTableCriteriaModel(final String entityID, final EntityConnectionProvider connectionProvider) {
    this(entityID, connectionProvider, new DefaultPropertyFilterModelProvider(), new DefaultPropertyCriteriaModelProvider());
  }
