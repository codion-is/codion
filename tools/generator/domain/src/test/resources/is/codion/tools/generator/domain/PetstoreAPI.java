...
public interface Petstore {
	...
	interface Address {
		EntityType TYPE = DOMAIN.entityType("petstore.address", Address.class);
	...
	interface Category {
		EntityType TYPE = DOMAIN.entityType("petstore.category", Category.class);
	...
	interface ContactInfo {
		EntityType TYPE = DOMAIN.entityType("petstore.contact_info", ContactInfo.class);
	...
	interface ItemTagsView {
		EntityType TYPE = DOMAIN.entityType("petstore.item_tags", ItemTagsView.class);
	...
	interface Tag {
		EntityType TYPE = DOMAIN.entityType("petstore.tag", Tag.class);
	...
	interface Product {
		EntityType TYPE = DOMAIN.entityType("petstore.product", Product.class);
	...
	interface Item {
		EntityType TYPE = DOMAIN.entityType("petstore.item", Item.class);
	...
	interface TagItem {
		EntityType TYPE = DOMAIN.entityType("petstore.tag_item", TagItem.class);
