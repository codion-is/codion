...
public class InvoicePanel extends EntityPanel {
  ...
  public InvoicePanel(final EntityModel model) {
    ...
    addDetailPanel(new InvoiceLinePanel(model.getDetailModel(T_INVOICELINE)));
  }

  static class InvoiceEditPanel extends EntityEditPanel {

    InvoiceEditPanel(final EntityEditModel editModel) {
      super(editModel);
    }
