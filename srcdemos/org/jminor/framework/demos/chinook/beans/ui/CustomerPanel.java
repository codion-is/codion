...
public class CustomerPanel extends EntityPanel {
  ...
  public CustomerPanel(final EntityModel model) {
    super(model, new CustomerEditPanel(model.getEditModel()));
    addDetailPanel(new InvoicePanel(model.getDetailModel(T_INVOICE)));
  }

  static class CustomerEditPanel extends EntityEditPanel {

    CustomerEditPanel(final EntityEditModel editModel) {
      super(editModel);
    }
