...
public final class ConfigurationTest {
	...
	void filePath() {
		...
		store = loadFromFile("src/test/resources/is/codion/common/utilities/item/item_config_test.config", false);
		...
		store = loadFromFile("src/test/resources/is/codion/common/utilities/item/item_config_test_non_existing.config", false);
