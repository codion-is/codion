...
public interface SessionContext {
	 ...
	 */
	void prepare(Connection connection, ClientInfo clientInfo) throws SQLException;
	 ...
	 * <p>Always called for a context whose {@link #prepare(Connection, ClientInfo)} was called, so that an
	 ...
	 */
	void release(Connection connection, ClientInfo clientInfo) throws SQLException;
}
