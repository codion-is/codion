...
We create a *main()* method for configuring and running the application. See <<{basedir}/technical/client-configuration.adoc#_client_configuration, client configuration>> for what configuration is required for running the client.
