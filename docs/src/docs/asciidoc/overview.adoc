...
First we define the entity based on the table *store.customer*.
...
Next we define the entity based on the table *store.address*.
...
And finally we define the entity based on the _many-to-many_ relationship table *store.customer_address*.
