...
The domain model is based around two classes, {url-javadoc}/org/jminor/framework/domain/Entity.html[Entity], which represents a row in a table, and {url-javadoc}/org/jminor/framework/domain/property/Property.html[Property], which represents columns. The
{url-javadoc}/org/jminor/framework/domain/Domain.html[Domain] class serves as a container for the domain model as well as a factory for Entity and Entity.Key objects.
