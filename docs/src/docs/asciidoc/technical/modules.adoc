...
[discrete]
=== jminor-framework-model-tests

.Dependency graph
[%collapsible]
====
image::modules/framework/model-tests/build/reports/dependency-graph/dependency-graph.svg[opts=interactive]
====
...
[discrete]
==== jminor-plugin-ikonli-foundation
