...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/domain/EmpDept.java[lines=18..29]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/domain/EmpDept.java[lines=31..53]
----
...
For further information on parameters required for running JMinor applications see <<{dir-technical}/client.adoc#_configuration, client configuration>> and <<{dir-technical}/server.adoc#_configuration, server configuration>>.
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/model/EmployeeEditModel.java[lines=17..23]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/model/EmployeeEditModel.java[lines=24..42]
----

Finally we bind a couple of events, for further information see <<{dir-manual}/manual.adoc#_event_binding, Manual#Event binding>>.

[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/model/EmployeeEditModel.java[lines=44..61]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/DepartmentEditPanel.java[lines=14..19]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/DepartmentEditPanel.java[lines=20..48]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/DepartmentTablePanel.java[lines=20..25]
----

We create a method for viewing a report, which is called via an action we'll initialize in the next step. For further information about report viewing and printing see <<{dir-manual}/manual.adoc#_reporting_with_jasperreports, Manual#Reporting with JasperReports>>.

[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/DepartmentTablePanel.java[lines=26..37]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/DepartmentTablePanel.java[lines=39..50]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/EmployeeEditPanel.java[lines=16..21]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/EmployeeEditPanel.java[lines=22..52]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/EmpDeptAppPanel.java[lines=30..55]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/EmpDeptAppPanel.java[lines=57..62]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/EmpDeptAppPanel.java[lines=64..70]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/EmpDeptAppPanel.java[lines=72..75]
----

We create a *main()* method for configuring and running the application. See <<{dir-technical}/client-configuration.adoc#_configuration, client configuration>> for what configuration is required for running the client.

[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/EmpDeptAppPanel.java[lines=77..84]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/EmpDeptAppPanel.java[lines=86..91]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/EmpDeptAppPanel.java[lines=93..103]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/EmpDeptAppPanel.java[lines=105..116]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/testing/EmpDeptLoadTest.java[lines=4..-1]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/domain/EmpDept.java[lines=4..-1]
----
...
[source,java]
----
include::{dir-test-source}/org/jminor/framework/demos/empdept/domain/EmpDeptTest.java[lines=4..-1]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/model/EmployeeEditModel.java[lines=4..-1]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/DepartmentEditPanel.java[lines=4..-1]
----

[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/DepartmentTablePanel.java[lines=4..-1]
----

[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/EmployeeEditPanel.java[lines=4..-1]
----

[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/ui/EmpDeptAppPanel.java[lines=4..-1]
----