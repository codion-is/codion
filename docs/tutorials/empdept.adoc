...
For further information on parameters required for running JMinor applications see <<{dir-technical}/client-configuration.adoc#, client configuration>> and <<{dir-technical}/server.adoc#configuration, server configuration>>.
