...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/domain/EmpDept.java[lines=16..27]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/domain/EmpDept.java[lines=29..50]
----
...
For further information on parameters required for running JMinor applications see <<{dir-technical}/_client_configuration.adoc#, client configuration>> and <<{dir-technical}/server.adoc#_configuration, server configuration>>.
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/beans/EmployeeEditModel.java[lines=44..61]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/beans/EmployeeEditModel.java[lines=4..-1]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/beans/ui/DepartmentEditPanel.java[lines=4..-1]
----

[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/beans/ui/DepartmentTablePanel.java[lines=4..-1]
----

[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/beans/ui/EmployeeEditPanel.java[lines=4..-1]
----

[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/client/ui/EmpDeptAppPanel.java[lines=4..-1]
----