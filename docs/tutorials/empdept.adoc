...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/beans/EmployeeEditModel.java[lines=18..21]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/beans/EmployeeEditModel.java[lines=23..41]
----
