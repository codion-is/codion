...
For further information on parameters required for running JMinor applications see <<{dir-technical}/client.adoc#configuration, client configuration>> and <<{dir-technical}/server.adoc#configuration, server configuration>>.
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/empdept/testing/EmpDeptLoadTest.java[lines=4..]
----
