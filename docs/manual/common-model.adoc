...
----
include::{dir-source}/org/jminor/framework/demos/manual/common/EventState.java[tags=event]
----
...
[source,java,indent=0]
----
include::{dir-source}/org/jminor/framework/demos/manual/common/EventState.java[tags=state]
----
...
[source,java,indent=0]
----
include::{dir-source}/org/jminor/framework/demos/manual/common/EventState.java[tags=action]
----
