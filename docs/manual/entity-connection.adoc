...
The domain model used in the examples below can be found here <<{dir-tutorials}/chinook.adoc#_domain_model, Chinook domain model>>

NOTE: Static imports are used extensively in the examples, click below to view.
...
----
include::{dir-source-chinook}/org/jminor/framework/demos/chinook/manual/EntityConnectionDemo.java[tags=staticImports]
----
====
