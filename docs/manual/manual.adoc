...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/manual/basics/EventState.java[lines=21..38]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/manual/basics/EventState.java[lines=40..59]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/manual/basics/EventState.java[lines=61..71]
----
