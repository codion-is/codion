...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/manual/store/model/AddressModel.java[lines=10..-1]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/manual/store/Misc.java[lines=20..52]
----
...
[source,java]
----
include::{dir-source}/org/jminor/framework/demos/manual/store/model/CustomerModel.java[lines=21..29]
----
