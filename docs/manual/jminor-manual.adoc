...
The following properties can be set by using chained method calls:
...
Example: [[documentation:tutorials:empdept#domain_model[EmpDept domain]
...
==== Examples ====
  ...
  * [[documentation:tutorials:chinook#domain_model[Chinook domain model]
  * [[documentation:tutorials:empdept#domain_model[EmpDept domain model]
  * [[documentation:tutorials:petstore#domain_model[Pet Store domain model]
...
==== Examples ====
  ...
  * [[documentation:tutorials:chinook#domain_model_unit_test[Chinook domain model test]
  * [[documentation:tutorials:empdept#domain_model_unit_test[EmpDept domain model test]
  * [[documentation:tutorials:petstore#domain_model_unit_test[Pet Store domain model test]
...
=== Examples
  * [[documentation:tutorials:empdept#application_model_layer[EmpDept entity models]
...
=== Examples
  ...
  * [[documentation:tutorials:empdept#application_load_test[EmpDept application load test]
  * [[documentation:tutorials:chinook#application_load_test[Chinook application load test]
  * [[documentation:tutorials:petstore#application_load_test[Pet Store application load test]
...
Adding a detail panel is done with a single method call, but note that the underlying EntityModel must contain the correct detail model for the detail panel, in this case a *CustomerModel* instance, see [[documentation:manual#detail_models[detail models].
[source,java]
----
...
=== Examples
  ...
  * [[documentation:tutorials:empdept#main_application_panel[EmpDept application panel]
  * [[documentation:tutorials:chinook#main_application_panel[Chinook application panel]
  * [[documentation:tutorials:petstore#main_application_panel[Pet Store application panel]
...
=== Examples
  ...
  * [[documentation:tutorials:empdept#application_ui_layer[EmpDept UI layer]