...
[source,java,indent=0]
----
include::{dir-source-world}/org/jminor/framework/demos/world/domain/World.java[tags=sequence]
----
...
[source,java,indent=0]
----
include::{dir-source-world}/org/jminor/framework/demos/world/domain/World.java[tags=validator]
----
