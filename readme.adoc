...
* Assembling a Swing client based on the domain model is very straight forward.
...
* Integrated https://github.com/TIBCOSoftware/jasperreports[JasperReports] support.
