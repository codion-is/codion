...
Codion framework binaries are available on Maven Central.

Snapshots of the current development version *{version}-SNAPSHOT* are available in link:https://s01.oss.sonatype.org/content/repositories/snapshots[Sonatype's snapshots repository].
