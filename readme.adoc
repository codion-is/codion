...
The `EntityTestUnit` class provides a JUnit testing harness for the domain model.
The `EntityTestUnit.test(entityType)` method runs insert, select, update and delete on a randomly (or manually) generated entity instance, verifying the results.
