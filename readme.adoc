...
Most of the following applications can be found in the `demos` folder of the Codion project, but are also available in separate Git repositories as fully configured stand-alone Gradle projects.
...
image::https://github.com/codion-is/sdkboy/blob/main/sdkboy/src/docs/asciidoc/images/sdkboy.png[SDKBoy client]
...
A simple LLM chat demo application.

image::https://github.com/codion-is/llemmy/blob/main/llemmy/src/docs/asciidoc/images/llemmy.png[Llemmy client]

Includes a local Ollama model runner and the application configured to interact with it.
