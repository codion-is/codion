...
image:https://img.shields.io/badge/JDK_Compatibility-21+-blue.svg[Java Compatability 21+]
image:https://img.shields.io/maven-central/v/is.codion/codion-swing-framework-ui?label=maven%20central&color=blue[link="https://central.sonatype.com/artifact/is.codion/codion-framework-bom"]
...
* <<Domain model, Domain modeling>> in plain Java code without annotations.
...
** A https://www.youtube.com/watch?v=2dDKjeqJJeQ[practically mouse free] user experience ({url-help}/client.html#_keyboard_shortcuts[keyboard shortcuts]).
...
* Rapid prototyping.
* The Swing UI toolkit, observable values and states, component builders, actions, tables and dialogs, {url-manual}/manual.html#_swing_common_ui_standalone[can be used by itself], in applications not requiring CRUD functionality, see <<_sdkboy, SDKBOY>>.
...
* *https://github.com/weisJ/jsvg[com.github.weisj:jsvg]* for application icon handling
* *https://github.com/Hakky54/ayza[io.github.hakky54:ayza]* for RMI truststore handling
...
https://codion.is/doc/{version}/tutorials/sdkboy/sdkboy.html[SDKBOY Tutorial]
...
https://codion.is/doc/{version}/tutorials/lemmy/lemmy.html[Llemmy Tutorial]
...
Minimalistic bare-bones CRUD application project, configured for a local JDBC connection.
A good place to start.

https://codion.is/doc/{version}/tutorials/petclinic/petclinic.html[Petclinic Tutorial]
...
Fully configured multi-module CRUD application project, with separate client modules configured for JDBC and RMI connections.

https://codion.is/doc/{version}/tutorials/world/world.html[World Tutorial]
...
https://codion.is/doc/{version}/tutorials/chinook/chinook.html[Chinook Tutorial]

Fully configured multi-module CRUD application project, with separate client modules configured for JDBC, RMI and HTTP connections.
...
// readme-source: main/java/is/codion/manual/app/readme/domain/Store.java
[source,java]
----
...
// readme-source: test/java/is/codion/manual/app/readme/domain/StoreTest.java
[source,java]
----
...
// readme-source: main/java/is/codion/manual/app/readme/ui/StoreDemo.java
[source,java]
----
...
|is.codion.framework.db|is.codion:codion-framework-db:{version}|Core
...
// readme-source: main/java/is/codion/manual/app/readme/db/StoreDatabase.java
[source,java]
----
Database database = H2DatabaseFactory
...
The rest have not been formally tested, but chances are they will just work, if not, https://github.com/codion-is/codion/issues[create an issue], and we'll figure it out.

== Localization

Localized messages are available in English (default) and Icelandic.
There are a lot of {url-technical}/i18n-values.html[localized messages] so if you are interested in providing translations that would be much appreciated.
