...
The framework provides ways to connect to a database remotely via the {url-technical}/technical.html#_server[Codion server], which serves clients using the RMI and HTTP connection options.
