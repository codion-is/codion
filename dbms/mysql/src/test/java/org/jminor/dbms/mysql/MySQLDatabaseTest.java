...
public class MySQLDatabaseTest {
  ...
  public void getSequenceQuery() {
    assertThrows(UnsupportedOperationException.class, () -> MySQLDatabase.mySqlDatabase("host", 1234, "sid").getSequenceQuery("seq"));
  }

  @Test
  public void supportsIsValid() {
    final MySQLDatabase db = MySQLDatabase.mySqlDatabase("host", 1234, "sid");
  ...
  public void constructorNullHost() {
    assertThrows(NullPointerException.class, () -> MySQLDatabase.mySqlDatabase(null, null, null));
  }
}