...
public final class World extends Domain {
  ...
  public static final Identity T_CITY = identity("world.city");
  public static final Attribute<Integer> CITY_ID = integerAttribute("id", T_CITY);
  public static final Attribute<String> CITY_NAME = stringAttribute("name", T_CITY);
  public static final Attribute<String> CITY_COUNTRY_CODE = stringAttribute("countrycode", T_CITY);
  public static final EntityAttribute CITY_COUNTRY_FK = entityAttribute("country_fk", T_CITY);
  public static final Attribute<String> CITY_DISTRICT = stringAttribute("district", T_CITY);
  public static final Attribute<Integer> CITY_POPULATION = integerAttribute("population", T_CITY);

  public static final Identity T_COUNTRY = identity("world.country");
  public static final Attribute<String> COUNTRY_CODE = stringAttribute("code", T_COUNTRY);
  public static final Attribute<String> COUNTRY_NAME = stringAttribute("name", T_COUNTRY);
  public static final Attribute<String> COUNTRY_CONTINENT = stringAttribute("continent", T_COUNTRY);
  public static final Attribute<String> COUNTRY_REGION = stringAttribute("region", T_COUNTRY);
  public static final Attribute<Double> COUNTRY_SURFACEAREA = doubleAttribute("surfacearea", T_COUNTRY);
  public static final Attribute<Integer> COUNTRY_INDEPYEAR = integerAttribute("indepyear", T_COUNTRY);
  public static final Attribute<Integer> COUNTRY_POPULATION = integerAttribute("population", T_COUNTRY);
  public static final Attribute<Double> COUNTRY_LIFEEXPECTANCY = doubleAttribute("lifeexpectancy", T_COUNTRY);
  public static final Attribute<Double> COUNTRY_GNP = doubleAttribute("gnp", T_COUNTRY);
  public static final Attribute<Double> COUNTRY_GNPOLD = doubleAttribute("gnpold", T_COUNTRY);
  public static final Attribute<String> COUNTRY_LOCALNAME = stringAttribute("localname", T_COUNTRY);
  public static final Attribute<String> COUNTRY_GOVERNMENTFORM = stringAttribute("governmentform", T_COUNTRY);
  public static final Attribute<String> COUNTRY_HEADOFSTATE = stringAttribute("headofstate", T_COUNTRY);
  public static final Attribute<Integer> COUNTRY_CAPITAL = integerAttribute("capital", T_COUNTRY);
  public static final EntityAttribute COUNTRY_CAPITAL_FK = entityAttribute("capital_fk", T_COUNTRY);
  public static final Attribute<String> COUNTRY_CODE2 = stringAttribute("code2", T_COUNTRY);
  public static final Attribute<Integer> COUNTRY_CAPITAL_POPULATION = integerAttribute("capital_population", T_COUNTRY);
  public static final Attribute<Integer> COUNTRY_NO_OF_CITIES = integerAttribute("no_of_cities", T_COUNTRY);
  public static final Attribute<Integer> COUNTRY_NO_OF_LANGUAGES = integerAttribute("no_of_languages", T_COUNTRY);
  public static final BlobAttribute COUNTRY_FLAG = blobAttribute("flag", T_COUNTRY);

  public static final Identity T_COUNTRYLANGUAGE = identity("world.countrylanguage");
  public static final Attribute<String> COUNTRYLANGUAGE_COUNTRY_CODE = stringAttribute("countrycode", T_COUNTRYLANGUAGE);
  public static final EntityAttribute COUNTRYLANGUAGE_COUNTRY_FK = entityAttribute("country_fk", T_COUNTRYLANGUAGE);
  public static final Attribute<String> COUNTRYLANGUAGE_LANGUAGE = stringAttribute("language", T_COUNTRYLANGUAGE);
  public static final Attribute<Boolean> COUNTRYLANGUAGE_ISOFFICIAL = booleanAttribute("isofficial", T_COUNTRYLANGUAGE);
  public static final Attribute<Double> COUNTRYLANGUAGE_PERCENTAGE = doubleAttribute("percentage", T_COUNTRYLANGUAGE);
  public static final Attribute<Integer> COUNTRYLANGUAGE_NO_OF_SPEAKERS = integerAttribute("no_of_speakers", T_COUNTRYLANGUAGE);
  // end::entityIdsAndAttributes[]

  public static final Identity T_CONTINENT = identity("continent");
  public static final Attribute<String> CONTINENT_CONTINENT = stringAttribute("continent", T_CONTINENT);
  public static final Attribute<Integer> CONTINENT_SURFACE_AREA = integerAttribute("sum(surfacearea)", T_CONTINENT);
  public static final Attribute<Long> CONTINENT_POPULATION = longAttribute("sum(population)", T_CONTINENT);
  public static final Attribute<Double> CONTINENT_MIN_LIFE_EXPECTANCY = doubleAttribute("min(lifeexpectancy)", T_CONTINENT);
  public static final Attribute<Double> CONTINENT_MAX_LIFE_EXPECTANCY = doubleAttribute("max(lifeexpectancy)", T_CONTINENT);
  public static final Attribute<Integer> CONTINENT_MIN_INDEPENDENCE_YEAR = integerAttribute("min(indepyear)", T_CONTINENT);
  public static final Attribute<Integer> CONTINENT_MAX_INDEPENDENCE_YEAR = integerAttribute("max(indepyear)", T_CONTINENT);
  public static final Attribute<Double> CONTINENT_GNP = doubleAttribute("sum(gnp)", T_CONTINENT);

  public static final Identity T_LOOKUP = identity("world.country_city_v");
  public static final Attribute<String> LOOKUP_COUNTRY_CODE = stringAttribute("countrycode", T_LOOKUP);
  public static final Attribute<String> LOOKUP_COUNTRY_NAME = stringAttribute("countryname", T_LOOKUP);
  public static final Attribute<String> LOOKUP_COUNTRY_CONTINENT = stringAttribute("continent", T_LOOKUP);
  public static final Attribute<String> LOOKUP_COUNTRY_REGION = stringAttribute("region", T_LOOKUP);
  public static final Attribute<Double> LOOKUP_COUNTRY_SURFACEAREA = doubleAttribute("surfacearea", T_LOOKUP);
  public static final Attribute<Integer> LOOKUP_COUNTRY_INDEPYEAR = integerAttribute("indepyear", T_LOOKUP);
  public static final Attribute<Integer> LOOKUP_COUNTRY_POPULATION = integerAttribute("countrypopulation", T_LOOKUP);
  public static final Attribute<Double> LOOKUP_COUNTRY_LIFEEXPECTANCY = doubleAttribute("lifeexpectancy", T_LOOKUP);
  public static final Attribute<Double> LOOKUP_COUNTRY_GNP = doubleAttribute("gnp", T_LOOKUP);
  public static final Attribute<Double> LOOKUP_COUNTRY_GNPOLD = doubleAttribute("gnpold", T_LOOKUP);
  public static final Attribute<String> LOOKUP_COUNTRY_LOCALNAME = stringAttribute("localname", T_LOOKUP);
  public static final Attribute<String> LOOKUP_COUNTRY_GOVERNMENTFORM = stringAttribute("governmentform", T_LOOKUP);
  public static final Attribute<String> LOOKUP_COUNTRY_HEADOFSTATE = stringAttribute("headofstate", T_LOOKUP);
  public static final Attribute<String> LOOKUP_COUNTRY_CODE2 = stringAttribute("code2", T_LOOKUP);
  public static final BlobAttribute LOOKUP_COUNTRY_FLAG = blobAttribute("flag", T_LOOKUP);
  public static final Attribute<Integer> LOOKUP_CITY_ID = integerAttribute("cityid", T_LOOKUP);
  public static final Attribute<String> LOOKUP_CITY_NAME = stringAttribute("cityname", T_LOOKUP);
  public static final Attribute<String> LOOKUP_CITY_DISTRICT = stringAttribute("district", T_LOOKUP);
  public static final Attribute<Integer> LOOKUP_CITY_POPULATION = integerAttribute("citypopulation", T_LOOKUP);
