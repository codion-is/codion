...
VALUES (8, 'King', 'President', NULL, '1981-11-17', 5000, NULL, 10),
  ...
  (5, 'Blake', 'Manager', 8, '1981-05-01', 2850, NULL, 30),
  (1, 'Allen', 'Salesman', 5, '1981-02-20', 1600, 300, 30),
  (2, 'Ward', 'Salesman', 5, '1981-02-22', 1250, 500, 30),
  (4, 'Martin', 'Salesman', 5, '1981-09-28', 1250, 1400, 30),
  ...
  (11, 'James', 'Clerk', 6, '1996-10-03', 950, 1500, 10),
  (12, 'Ford', 'Clerk', 3, '1988-12-12', 3200, 1200, 20),
  (13, 'Miller', 'Clerk', 6, '1983-01-23', 1300, 1200, 10),
  (14, 'Ben', 'Clerk', 3, '1989-12-12', 1600, 1200, 20),
  (15, 'Baker', 'Clerk', 6, '2007-01-01', 1000, NULL, 10),
  (16, 'Trevor', 'Clerk', 6, '2007-01-01', 1000, NULL, 10);
