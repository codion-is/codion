...
public interface Clinic {
  ...
  EntityType T_VET = entityType("petclinic.vet");
  ...
  EntityType T_SPECIALTY = entityType("petclinic.specialty");
  ...
  EntityType T_VET_SPECIALTY = entityType("petclinic.vet_specialty");
  ...
  EntityType T_PET_TYPE = entityType("petclinic.pet_type");
  ...
  EntityType T_OWNER = entityType("petclinic.owner");
  ...
  EntityType T_PET = entityType("petclinic.pet");
  ...
  EntityType T_VISIT = entityType("petclinic.visit");
