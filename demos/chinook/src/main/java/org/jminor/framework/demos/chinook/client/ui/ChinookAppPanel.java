...
public final class ChinookAppPanel extends EntityApplicationPanel<ChinookAppPanel.ChinookApplicationModel> {
  ...
  public static void main(final String[] args) throws CancelException {
    ...
    EntityEditPanel.DISPLAY_DEPENDENCIES_ON_REFERENTIAL_INTEGRITY_ERROR.set(true);
    EntityTablePanel.DISPLAY_DEPENDENCIES_ON_REFERENTIAL_INTEGRITY_ERROR.set(true);
