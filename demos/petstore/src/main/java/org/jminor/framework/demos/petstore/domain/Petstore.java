...
public final class Petstore extends Entities {
  ...
  void defineAddress() {
    define(T_ADDRESS, "petstore.address",
            ...
            columnProperty(ADDRESS_STREET_2, Types.VARCHAR, "Street 2").setMaxLength(55),
            columnProperty(ADDRESS_CITY, Types.VARCHAR, "City").setMaxLength(55).setNullable(false),
            columnProperty(ADDRESS_STATE, Types.VARCHAR, "State").setMaxLength(25).setNullable(false),
            columnProperty(ADDRESS_ZIP, Types.INTEGER, "Zip").setNullable(false),
            columnProperty(ADDRESS_LATITUDE, Types.DOUBLE, "Latitude").setNullable(false).setMaximumFractionDigits(2),
  ...
  void defineCategory() {
    define(T_CATEGORY, "petstore.category",
            ...
            columnProperty(CATEGORY_DESCRIPTION, Types.VARCHAR, "Description").setMaxLength(255).setNullable(false),
  ...
  void defineProduct() {
    define(T_PRODUCT, "petstore.product",
            ...
            foreignKeyProperty(PRODUCT_CATEGORY_FK, "Category", T_CATEGORY,
                    columnProperty(PRODUCT_CATEGORY_ID)).setNullable(false),
            columnProperty(PRODUCT_NAME, Types.VARCHAR, "Name").setMaxLength(25).setNullable(false),
            columnProperty(PRODUCT_DESCRIPTION, Types.VARCHAR, "Description").setMaxLength(255).setNullable(false),
  ...
  void defineSellerContactInfo() {
    define(T_SELLER_CONTACT_INFO, "petstore.sellercontactinfo",
            ...
            columnProperty(SELLER_CONTACT_INFO_LAST_NAME, Types.VARCHAR, "Last name").setMaxLength(24).setNullable(false),
  ...
  void defineItem() {
    define(T_ITEM, "petstore.item",
            ...
            foreignKeyProperty(ITEM_PRODUCT_FK, "Product", T_PRODUCT,
                    columnProperty(ITEM_PRODUCT_ID)).setFetchDepth(2).setNullable(false),
            columnProperty(ITEM_NAME, Types.VARCHAR, "Name").setMaxLength(30).setNullable(false),
            ...
            foreignKeyProperty(ITEM_ADDRESS_FK, "Address", T_ADDRESS,
                    columnProperty(ITEM_ADDRESS_ID)).setNullable(false),
