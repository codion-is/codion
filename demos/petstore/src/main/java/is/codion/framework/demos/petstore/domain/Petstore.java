...
public final class Petstore extends Domain {
  ...
  public static final EntityType T_ADDRESS = entityType("address");
  ...
  public static final EntityType T_CATEGORY = entityType("category");
  ...
  public static final EntityType T_PRODUCT = entityType("product");
  ...
  public static final EntityType T_SELLER_CONTACT_INFO = entityType("sellercontactinfo");
  ...
  public static final EntityType T_ITEM = entityType("item");
  ...
  public static final EntityType T_TAG = entityType("tag");
  ...
  public static final EntityType T_TAG_ITEM = entityType("tag_item");
