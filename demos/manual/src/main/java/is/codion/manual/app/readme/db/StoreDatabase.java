 ...
 */
package is.codion.manual.app.readme.db;
...
import is.codion.manual.app.readme.domain.Store;

import java.util.List;

import static is.codion.framework.domain.entity.condition.Condition.and;
import static is.codion.manual.app.readme.domain.Store.Address;
import static is.codion.manual.app.readme.domain.Store.Customer;
