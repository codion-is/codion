...
import is.codion.manual.framework.domain.DomainModelDemo.Store.City;
import is.codion.manual.framework.domain.DomainModelDemo.Store.Customer;

import java.util.List;

class DomainModelDemo {
