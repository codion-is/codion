 ...
 */
package is.codion.manual.swing.framework.model;
...
import is.codion.manual.app.store.model.CustomerEditModel;
import is.codion.swing.framework.model.SwingEntityEditor;

import java.util.UUID;

public final class EntityEditorDemo {

	static void editor() throws EntityValidationException {
		// tag::editModel[]
