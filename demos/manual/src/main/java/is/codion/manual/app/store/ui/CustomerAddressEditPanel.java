 ...
 */
package is.codion.manual.app.store.ui;

import is.codion.manual.app.store.domain.Store.Address;
import is.codion.manual.app.store.domain.Store.CustomerAddress;
...
public class CustomerAddressEditPanel extends EntityEditPanel {
	...
	protected void initializeUI() {
		create().comboBoxInput(CustomerAddress.ADDRESS_FK, this::createAddressEditPanel)
						.preferredWidth(280)
