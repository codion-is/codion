...
public final class ClasspathConfiguration {
	 ...
	 * </ul>
	 */
	public static final PropertyValue<String> CONFIGURATION_FILE = stringValue("java.util.logging.config.file");
	...
	public ClasspathConfiguration() {
		String configFile = CONFIGURATION_FILE.get();
		if (configFile == null) {
			System.err.println("Unable to configure java.util.logging from classpath: java.util.logging.config.file property not specified");
			return;
		}
