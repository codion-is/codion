 ...
 */
public final class GradiantoDarkFuchsia extends IntelliJTheme.ThemeLaf {

	public GradiantoDarkFuchsia() {
		super(load(GradiantoDarkFuchsia.class.getResourceAsStream("Gradianto_dark_fuchsia.theme.json")));
	}
}
