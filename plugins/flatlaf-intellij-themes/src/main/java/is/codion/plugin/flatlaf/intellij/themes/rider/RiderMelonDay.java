 ...
 */
public final class RiderMelonDay extends IntelliJTheme.ThemeLaf {

	public RiderMelonDay() {
		super(load(RiderMelonDay.class.getResourceAsStream("RiderMelonDay.theme.json")));
	}
}
