 ...
 */
public final class GruvboxDarkHard extends IntelliJTheme.ThemeLaf {

	public GruvboxDarkHard() {
		super(load(GruvboxDarkHard.class.getResourceAsStream("gruvbox_dark_hard.theme.json")));
	}
}
