 ...
 */
package is.codion.plugin.flatlaf.intellij.themes.espresso;
...
public final class EspressoLight extends IntelliJTheme.ThemeLaf {
	...
	public EspressoLight() {
		super(load(EspressoLight.class.getResourceAsStream("espresso_light.theme.json")));
	}
}
