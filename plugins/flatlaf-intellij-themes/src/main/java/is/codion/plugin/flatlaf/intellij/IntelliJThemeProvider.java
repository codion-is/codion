...
public final class IntelliJThemeProvider implements LookAndFeelProvider {
	...
	public IntelliJThemeProvider() {
		providers = unmodifiableList(asList(
						...
						lookAndFeelEnabler(new LookAndFeelInfo("Everforest Ligth Hard", EverforestLightHard.class.getName())),
						lookAndFeelEnabler(new LookAndFeelInfo("Everforest Ligth Medium", EverforestLightMedium.class.getName())),
						lookAndFeelEnabler(new LookAndFeelInfo("Everforest Ligth Soft", EverforestLightSoft.class.getName())),
