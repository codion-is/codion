 ...
 */
public final class GruvboxDarkSoft extends IntelliJTheme.ThemeLaf {

	public GruvboxDarkSoft() {
		super(load(GruvboxDarkSoft.class.getResourceAsStream("gruvbox_dark_soft.theme.json")));
	}
}
