...
public final class TestDomain extends Domain {
  ...
  public static final Attribute<BigDecimal> ENTITY_DECIMAL = attribute("id");
  public static final Attribute<LocalDateTime> ENTITY_DATE_TIME = attribute("date_time");
  public static final Attribute<byte[]> ENTITY_BLOB = attribute("blob");
  public static final Attribute<String> ENTITY_READ_ONLY = attribute("read_only");
  public static final Attribute<Boolean> ENTITY_BOOLEAN = attribute("boolean");
  public static final Attribute<LocalTime> ENTITY_TIME = attribute("time");
  ...
  public static final Attribute<byte[]> DEPARTMENT_LOGO = attribute("logo");
