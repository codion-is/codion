...
public final class TestDomain {
  ...
  public static final String T_MASTER = "json.master_entity";
  ...
  public static final String DETAIL_SELECT_TABLE_NAME = "json.entity_test_select";

  @Entity.Table(orderByClause = DETAIL_STRING, selectTableName = DETAIL_SELECT_TABLE_NAME)
  public static final String T_DETAIL = "json.detail_entity";
  ...
  public static final String SCOTT_DOMAIN_ID = "json.scott.domain";
  ...
  public static final String T_DEPARTMENT = "json.scott.dept";
  ...
  @Property.Column(entityID = "json.scott.emp", columnName = "empno")
  public static final String EMP_ID = "emp_id";
  @Property.Column(entityID = "json.scott.emp", columnName = "ename")
  ...
  public static final String T_EMP = "json.scott.emp";
